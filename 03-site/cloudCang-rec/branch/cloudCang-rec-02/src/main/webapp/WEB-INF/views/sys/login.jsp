...
<head>
    ...
    <title>登录 - 37号仓智能云识别平台管理系统</title>
    <meta name="keywords" content="37号仓智能标注平台管理系统" />
    <meta name="description" content="37号仓智能标注平台管理系统" />
    <link href="${staticSource}/resources/hplus/css/login.css" rel="stylesheet">
    <script src="${staticSource}/resources/js/jquery.min.js?v=2.1.4"></script>
</head>
<body>
<div class="logon">
    <form action="${ctx}/rec/login" accept-charset="utf-8" id="loginForm" method="post" onsubmit="return doSubmit();">
...
<script type="text/javascript">
    <shiro:user>
    window.location.href="${ctx}/rec/main";
    </shiro:user>
