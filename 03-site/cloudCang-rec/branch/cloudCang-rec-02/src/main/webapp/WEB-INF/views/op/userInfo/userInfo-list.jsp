                    ...
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            <div class="layui-input-inline">
                                <input type="text" name="scode" id="scode" value="" placeholder="用户编号..."
                                       class="layui-input">
                            </div>
                            <div class="layui-input-inline">
                                <input type="text" name="snickName" id="snickName" value="" placeholder="用户名..."
                                       class="layui-input">
                            </div>
                            <div class="layui-input-inline">
                            ...
                            <div class="layui-input-inline">
                                <cang:select type="list" list="{10:个人用户,20:企业用户}" id="imemberType"
                                             name="imemberType" entire="true" entireName="请选择用户类型"/>
                            </div>
                            <div class="layui-input-inline">
                                <cang:select type="list" list="{1:正常,2:注销停用,3:系统黑名单,4:冻结}" id="istatus"
                                             name="istatus" entire="true" entireName="请选择用户状态"/>
                            </div>
                            <div class="layui-input-inline">
...
//执行一个laydate实例
    ...
    var colModel = [{name: 'id', index: 'id', hidden: true},
        ...
        {name: 'snickName', index: 'SNICK_NAME', label: "用户名", width: 60},
        {name: 'smobile', index: 'SMOBILE', label: "手机号码", width: 60},
        {name: 'semail', index: 'SEMAIL', label: "邮箱", width: 100},
        {
            name: 'imemberType', index: 'IMEMBER_TYPE', label: "用户类型", width: 60, formatter: "select",
            editoptions: {value: '10:个人用户;20:企业用户'}
        }, {
        ...
        {
            name: 'istatus', index: 'istatus', label: "状态", width: 40, formatter: "select",
        ...
        {name: 'merchantName', index: 'MERCHANT_NAME', label: "商户名", width: 80},
