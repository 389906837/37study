...
//执行一个laydate实例
    ...
    var colModel = [{name: 'id', index: 'id', hidden: true},
        ...
        {name: 'smodelAddress', index: 'SMODEL_ADDRESS', label: "模型地址", width: 170},
        ...
        {
            name: 'istatus', index: 'ISTATUS', label: "审核状态", width: 60, formatter: "select",
            editoptions: {value: '10:待审核;20:审核通过;30:审核驳回'}
        }, {
            name: 'tauditTime', index: 'TAUDIT_TIME', label: "审核时间", width: 90, formatter: function (value) {
                if (isEmpty(value)) {
                    return '';
                }
        ...
        {name: 'sauditOperName', index: 'SAUDIT_OPER_NAME', label: "审核人姓名", width: 60},
