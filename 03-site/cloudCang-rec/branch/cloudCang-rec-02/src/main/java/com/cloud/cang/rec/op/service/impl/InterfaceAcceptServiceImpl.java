...
public class InterfaceAcceptServiceImpl extends GenericServiceImpl<InterfaceAccept, String> implements
    ...
    public static void main(String[] args) throws IOException {
       /* Map<String, String> map = new HashMap();
        ...
        Map<String, String> map = new HashMap();
        map.put("appKey", "37cang");
        map.put("mobile", "1333333");
        map.put("token", "11111");
        String status = WebUtils.doPost("http://10.0.101.237:7084/api/custom/37cang/v1/member_sel", map, "UTF-8", 12312312, 1231231, "", 1);
        System.out.println(status);
    }
}