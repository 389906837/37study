...
public class MerchantInfoController {
     ...
     */
    @RequestMapping("/getMerchantByCodes")
    @ResponseBody
    ResponseVo<List<SelectMerchantVo>> getMerchantByCodes(String[] merchantCodes) {
        ...
        if (null != merchantCodes) {
            ...
            for (String merchantCode : merchantCodes) {//循环设备ID
                temp = merchantInfoService.selectByCode(merchantCode);
                if (null != temp) {
