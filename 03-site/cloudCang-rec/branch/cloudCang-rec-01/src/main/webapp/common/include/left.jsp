...
<nav class="navbar-default navbar-static-side" role="navigation">
    ...
    <div class="sidebar-collapse">
        ...
        <div class="sidebar-copyright">
            ...
            <a href="http://www.37cang.com" target="_blank" style="color:#b0bfcd;">www.37cang.com</a></br>
    ...
    <script type="text/javascript">
        ...
        function menuItem() {
            ...
            // 选项卡菜单不存在
            if (flag) {
                //var str = '<li><a href="javascript:;" class="active J_menuTab" data-id="/mgr/index">首页</a></li>';
        ...
        function scrollToTab(element) {
            var marginLeftVal = calSumWidth($(element).parents(".J_menuTab").prevAll()), marginRightVal = calSumWidth($(element).parents(".J_menuTab").nextAll());
            // 可视区域非tab宽度
