...
//执行一个laydate实例
    ...
    var colModel = [{name: 'id', index: 'id', hidden: true},
        ...
        {
            name: 'ivalidityType', index: 'IVALIDITY_TYPE', label: "有效期类型", width: 80, formatter: "select",
            editoptions: {value: '10:固定日期;20:长期有效'}
        },
        {
            name: 'istatus', index: 'ISTATUS', label: "状态", width: 80, formatter: "select",
            editoptions: {value: '10:已开通;20:已关闭'}
        },
        {name: "process", index: "process", title: false, label: "操作", sortable: false, frozen: true, width: 50}
    ]
    // 表格回调
    ...
    function closeMethod(sid) {
        confirmDelTip("确定要关闭接口账户?", ctx + "/interfaceAccount/close", {checkboxId: sid});
    }
