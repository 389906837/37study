...
<title>37号仓云识别平台</title>
<meta name="keywords" content="37号仓云识别平台" />
<meta name="description" content="37号仓云识别平台" />
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg" style="padding: 0 0;">
        ...
        <div class="J_mainContent" id="content-main" style="height: calc(100%); ">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/rec/index" frameborder="0" data-id="/rec/index" seamless></iframe>
        </div>
