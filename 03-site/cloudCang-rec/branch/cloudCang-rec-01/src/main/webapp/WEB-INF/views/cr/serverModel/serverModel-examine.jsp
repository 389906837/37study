...
<div class="ibox-content">
    <form class="layui-form" action="${ctx}/serverModel/serverModelAudit" method="post" id="myForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                    <textarea id="sauditReason" name="sauditReason"
                              class="layui-textarea layui-form-textarea80p"
                              placeholder="审核意见(驳回必填)"></textarea>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('submit(myFormSub)', function () {
            ...
            if (30 == istatus && isEmpty(sauditReason)) {
                alertDel("审核驳回原因不能为空！");
                return false;
            }
