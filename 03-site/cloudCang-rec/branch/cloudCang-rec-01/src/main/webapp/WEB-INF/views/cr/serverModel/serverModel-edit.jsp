...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#selectMerchant").click(function () {
            ...
            if (!isEmpty(merchantCodes)) {
                showLayer("选择商户", ctx + "/merchantInfo/selectMultipleMerchant?commodityIds=" + merchantIds + "&commodityCodes=" + merchantCodes, {area: ['90%', '80%']});
            } else {
    ...
    function initMerchantTable() {
        var merchantCodes = $("#srangeList").val();
        if (isEmpty(merchantCodes)) {//没有选择商户
            hideMerchantTable();
            return;
        }
        $.ajax({
            url: ctx + '/merchantInfo/getMerchantByCodes',
            type: 'POST', //GET
