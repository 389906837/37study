...
<div class="ibox-content">
    <form class="layui-form" action="${ctx}/gpuServer/saveServerStatus" method="post" id="myForm" enctype="multipart/form-data">
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <cang:select type="list" name="istatus" id="istatus"
                                 ...
                                 value="${serverList.istatus}" list="{20:已上线,30:故障,40:已废弃}"/>
                </div>
            </div>
        </div>
