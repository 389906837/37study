...
import com.cloud.cang.rec.common.StreamRenderUtil;
...
public class LoginController {
    ...
    public String redictMain(ModelMap modelMap) {
        try {
            ...
            //首页 系统公告
            String json = (String) iCached.hget(RedisConst.WZ_REGIO_ANNOUNCEMENT + authVo.getSmerchantCode(), RedisConst.WZ_REGIO_DETAIL_ + "WZRE0071" + authVo.getSmerchantCode());
    ...
    public @ResponseBody
    ResponseVo<String> getMsgCode(String username, String kaptchaCode, HttpServletRequest request) {
        try {
            //验证码校验
...
/*    	Set<ParameterGroupDetail> set=new HashSet<ParameterGroupDetail>();
    ...
    public @ResponseBody
    ResponseVo<String> getMsgCode(String sauditOperatorName, HttpServletRequest request) {
        try {
            // 校验用户
