...
<script type="text/javascript">
    ...
    var colModel = [{name: 'id', index: 'id', hidden: true},
        ...
        {name: 'userName', index: 'userName', label: "用户名", width: 50},
        {name: 'sappId', index: 'SAPP_ID', label: "应用AppId", width: 170},
        ...
        {
            name: 'ipayType', index: 'IPAY_TYPE', label: "接口收费类型", width: 90, formatter: "select",
        ...
        {
            name: 'iopenTime', index: 'IOPEN_TIME', label: "开通时间", width: 100, formatter: function (value) {
            if (isEmpty(value)) {
                return '';
            }
        ...
        {name: "process", index: "process", title: false, label: "操作", sortable: false, frozen: true, width: 35}
    ]
    // 表格回调
        ...
        setTimeout(function () {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                if (20 == ids[i].iauthStatus) {
                    <shiro:hasPermission name="USER_INTERFACE_AUTH_OPEN">
