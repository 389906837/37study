...
<div class="ibox-content">
    <form class="layui-form" action="${ctx}/recognitionServer/save" method="post" id="myForm"
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sname" id="sname" datatype="*" nullmsg="请输入服务器名称"
                           value="${recognitionServer.sname}" class="layui-input"/>
                </div>
            </div>
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sip" id="sip" datatype="*" nullmsg="请输入服务器IP"
                           value="${recognitionServer.sip}" class="layui-input"/>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sport" id="sport" datatype="*" nullmsg="请输入服务器端口"
                           value="${recognitionServer.sport}" class="layui-input"/>
                </div>
            </div>
        ...
        <div class="layui-form-item mt13">
            ...
            <div class="layui-input-block">
                    <textarea id="sremark" name="sremark" class="layui-textarea layui-form-textarea80p"
                              placeholder="（非必填项）">${recognitionServer.sremark}</textarea>
            </div>
        </div>
