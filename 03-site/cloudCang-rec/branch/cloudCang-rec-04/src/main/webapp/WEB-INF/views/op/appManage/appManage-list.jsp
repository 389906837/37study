...
//执行一个laydate实例
    ...
    var colModel = [{name: 'id', index: 'id', hidden: true},
        ...
        {name: 'sappId', index: 'SAPP_ID', label: "AppId", width: 100},
        {name: 'sappSecretKey', index: 'SAPP_SECRET_KEY', label: "AppSecret", width: 100},
        {
        ...
        {name: 'snickName', index: 'SNICK_NAME', label: "用户名", width: 50},
        {
            name: 'iauditStatus', index: 'IAUDIT_STATUS', label: "审核状态", width: 50, formatter: "select",
