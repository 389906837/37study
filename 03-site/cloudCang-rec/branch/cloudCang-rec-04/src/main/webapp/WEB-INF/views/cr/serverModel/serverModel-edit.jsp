    ...
    <form class="layui-form" action="${ctx}/serverModel/save" method="post" id="myForm" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sname" id="sname" datatype="*" nullmsg="请输入模型名称"
                           value="${serverModel.sname}" class="layui-input"/>
                </div>
            </div>
            <div class="layui-col-md6">
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <cang:select type="list" name="imodelType" id="imodelType"
                                 exp="datatype=\"*\" nullmsg=\"请选择模型类型\""
                                 value="${serverModel.imodelType}" list="{10:bmodel模型,20:darknet模型}"/>
                </div>
            </div>
        </div>
