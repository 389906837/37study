...
<link rel="shortcut icon" href="${dynamicSource}/favicon.ico" />
...
<link href="${staticSource}/resources/hplus/css/style.css?v=9" rel="stylesheet">
<!--[if lt IE 9]>
...
<script src="${staticSource}/resources/js/base.js?72"></script>
<![endif]-->
