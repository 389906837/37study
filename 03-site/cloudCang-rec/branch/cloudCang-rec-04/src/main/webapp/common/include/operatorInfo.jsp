...
<li class="nav-header">
    <div class="dropdown profile-element" style="text-align: left;">
        ...
        <span style="color:#fff;font-size:13px;padding-top:10px;display:block;line-height:22px;display:block;text-align:center;width:140px;margin:auto">${sessionScope.SESSION_KEY_USER.smerchantName}</span>
