...
public class AppManageController {
    ...
    @ResponseBody
    public PageListVo<List<AppManageVo>> queryData(ParamPage paramPage, AppManageDomain appManageDomain) {
        PageListVo<List<AppManageVo>> pageListVo = new PageListVo<List<AppManageVo>>();
        Page<AppManageVo> page = new Page<AppManageVo>();
