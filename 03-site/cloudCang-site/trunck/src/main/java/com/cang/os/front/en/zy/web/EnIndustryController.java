...
public class EnIndustryController {
	...
	private static final String INDUSTRY_NAV_ID="5861ddf76fd688c92bf1448d";
  ...
  public String detail(@PathVariable String id,ModelMap map) {
	    ...
	    return "front/en/zy/enIndustryDetail";
  }
