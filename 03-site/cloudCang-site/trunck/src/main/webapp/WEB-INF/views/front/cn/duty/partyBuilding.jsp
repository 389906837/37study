...
<head>
 ...
 <title>党建活动-社会责任-江苏子雨集团有限公司官网</title>
<meta name="keywords" content="子雨集团党建活动" />
<meta name="description" content="江苏子雨集团开展党建工作，做好党建文化的目的是为了服务于企业发展，为企业发展做好参谋，及时为企业发展献计献策。" />
...
<!-- 头部  -->
    ...
    <div class="ab_top wd">
    	<div class="ab_tp_lf">
        	<i class="ab_icon ab_address"></i>您当前所在位置：<a href="${ctx}/cn/index.html">首页 ></a><a href="${ctx}/cn/duty/commonweal.html">社会责任 > </a>党建活动
        </div>
        <div class="ab_tp_rg">
        	<ul>
            	<li><a href="${ctx}/cn/duty/commonweal.html">互公益</a></li>
                <li><a href="${ctx}/cn/duty/groupCommonweal.html">集团公益活动</a></li>
                <li class="title01"><a href="${ctx}/cn/duty/partyBuilding.html" class="hover">党建活动</a></li>
    ...
    <div class="ab_bg">
      ...
      <form action="${ctx}/cn/duty/partyBuilding" method="get" class="form-inline" role="form">   
   	  <div class="dj_content">
        	<div class="dj_title">党建活动</div>
