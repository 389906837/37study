...
<head>
 ...
 <title>工会-社会责任-江苏子雨集团有限公司官网</title>
<meta name="keywords" content="子雨集团工会委员会" />
<meta name="description" content="在2016年10月份，江苏子雨集团正式成立工会委员会，着力维护员工权益，进一步关爱员工。" />
...
<!-- 头部  -->
    ...
    <div class="ab_top wd">
    	<div class="ab_tp_lf">
        	<i class="ab_icon ab_address"></i>您当前所在位置：<a href="${ctx}/cn/index.html">首页 ></a><a href="${ctx}/cn/duty/commonweal.html">社会责任 > </a> 工会
        </div>
        <div class="ab_tp_rg">
        	<ul>
                ...
                <li class="title01"><a href="${ctx}/cn/duty/unions.html" class="hover">工会</a></li>
            </ul>
       </div>
    </div><!-- ab_top end-->
    <div class="ab_bg">
