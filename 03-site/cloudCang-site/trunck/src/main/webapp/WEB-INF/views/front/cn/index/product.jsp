    ...
    <form class="form-horizontal" id="myform"  method="post">
        ...
        <div class="form-group m-t-20 m-b-30">
            ...
            <a class=" col-sm-offset-3 submit-btn">提交</a>
                <%--<input type="submit" class=" col-sm-offset-3 submit-btn"value="提交">--%>
            </div>
        </form>
    </div>
...
<div class="products-img large-header" id="large-header" style="display: none"><canvas id="Mycanvas"></canvas></div>
<%--<div id="6id" value="content2.sarticleId "></div>--%>
<input type="hidden" id="6id" name="accountType" value="${content2.sarticleId}">
${content2.scontent}
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var idid = $("#6id").val();
       if(idid =='5c3d37c6b9e727cfcf4f6c9a'){
