...
<head>
 ...
 <title>政策法规-新闻中心-江苏子雨建团有限公司官网</title>
...
<!-- 头部  -->
    ...
    <div class="ab_top wd">
    	<div class="ab_tp_lf">
        	<i class="ab_icon ab_address"></i>您当前所在位置：<a href="${ctx}/cn/index.html">首页 ></a><a href="${ctx}/cn/news/group.html">新闻中心 ></a> 政策法规
        </div>
        <div class="ab_tp_rg">
        	<ul>
            	<li><a href="${ctx}/cn/news/group.html">集团新闻</a></li>
                <li><a href="${ctx}/cn/news/industry.html">行业动态</a></li>
                <li class="title01"><a href="${ctx}/cn/news/laws.html" class="hover">政策法规</a></li>
            </ul>
       </div>
    </div><!-- ab_top end-->
    <div class="ab_bg">
     <form action="${ctx}/cn/news/laws" method="get" class="form-inline" role="form">   
