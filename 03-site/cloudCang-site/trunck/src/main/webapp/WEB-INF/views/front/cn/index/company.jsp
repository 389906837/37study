...
<head>
    ...
    <title>关于我们 - 江苏叁拾柒号仓智能科技有限公司</title>
...
<div class="mediareportslist">
    <div class="container">
       <div class="navpath">
            ...
            <a href="${ctx}/">官网首页 > </a> <a class="active">关于我们</a>
        </div>
        <div class="listall">
            ...
            <c:if test="${not empty mediaList }">
                <c:forEach items="${mediaList}" var="art">
                    ...
                    <div class="listeach">
                        ...
                        <div class="details">
                            <a href="/news/company/${fn:replace(art.id,
                                '0000000000000000000000', '')}.html" style=""><h3>${art.stitle}</h3></a>
                            <p>${art.snewsAbstract}</p>
                        </div>
