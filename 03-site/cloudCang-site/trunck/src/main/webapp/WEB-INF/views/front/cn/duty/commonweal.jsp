...
<head>
 ...
 <title>互公益-社会责任-江苏子雨集团有限公司官网</title>
<meta name="keywords" content="互公益,子雨集团社会责任" />
<meta name="description" content="互公益是由互融宝平台依托江苏强业旗下主营产品互融宝金融产品特点，借助互融之意，联合地方残疾人福利机构发起的爱心捐助项目。" />
...
<!-- 头部  -->
    ...
    <div class="ab_top wd">
    	<div class="ab_tp_lf">
        	<i class="ab_icon ab_address"></i>您当前所在位置：<a href="${ctx}/cn/index.html">首页 ></a><a href="${ctx}/cn/duty/commonweal.html">社会责任 > </a> 互公益
        </div>
        <div class="ab_tp_rg">
        	<ul>
            	<li class="title01"><a href="${ctx}/cn/duty/commonweal.html" class="hover">互公益</a></li>
                <li><a href="${ctx}/cn/duty/groupCommonweal.html">集团公益活动</a></li>
    ...
    <div class="ab_bg">
        ...
        <div class="bendfit_step">
        	<div class="benefit_title">运作流程</div>
            <div class="benefit_pic"><img src="${staticSource}/static/front/images/benefit_step.png" width="1078" height="119" /></div>
        </div>
        <form action="${ctx}/cn/duty/commonweal" method="get" class="form-inline" role="form">   
   	   <div class="dj_content">
        	<div class="dj_title">互公益活动</div>
