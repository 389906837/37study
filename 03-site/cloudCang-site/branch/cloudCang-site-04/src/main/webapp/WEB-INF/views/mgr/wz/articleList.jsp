                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="stitleId" name="stitle"
                                       value="${articleVo.stitle}" placeholder="请输入文章标题">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <div class="group">
                                    <div class="col-sm-6" style="margin-left:-15px">
                                        <input type="text" class="form-control" id="startDateId" name="startDate"
                                               value="<f:formatDate value="${articleVo.startDate}" pattern="yyyy-MM-dd"/>"
                                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="请输发布开始时间">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="endDateId" name="endDate"
                                               value="<f:formatDate value="${articleVo.endDate}" pattern="yyyy-MM-dd"/>"
                                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="请输发布结束时间">
                                    </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select id="istatusId" name="istatus" class="form-control"
                                        value="${articleVo.istatus }">
                    ...
                    <div class="row" style="margin-top:20px;">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <hurbao:select type="col" cssClass="form-control" id="snavigationIdInput"
                                               name="snavigationId" objs="${navs}" listKey="id" listValue="sname"
                                               entire="true" value="${articleVo.snavigationId}"></hurbao:select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon">是否显示推荐</div>
                                <hurbao:select type="list" cssClass="form-control" id="iisRecommendId"
                                               name="iisRecommend" value="${articleVo.iisRecommend }" entire="true"
                                               list="{0:否,1:是}"></hurbao:select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon">是否置顶</div>
                                <hurbao:select type="list" cssClass="form-control" id="iistopicId" name="iistopic"
                                               value="${articleVo.iistopic }" entire="true"
                                               list="{0:否,1:是}"></hurbao:select>
                            </div>
                        </div>
                       <%-- <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon">是否显示推荐</div>
                                <hurbao:select type="list" cssClass="form-control" id="iisRecommendId" name="iisRecommend"
                                               value="${articleVo.iisRecommend }" entire="true"
                                               list="{0:否,1:是}"></hurbao:select>
                            </div>
                        </div>--%>
                        ...
                        <shiro:hasPermission name="edit_art">
                            <button type="button" class="btn btn-primary"
                                    onclick="javascript:window.location.href='${ctx}/mgr/article/edit'">新增
                            </button>
                        </shiro:hasPermission>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-striped table-condensed">
                    ...
                    <c:if test="${not empty page.results}">
                        <c:forEach items="${page.results}" var="op">
                            ...
                            <td><c:if test="${not empty op.stitleImageIndex}"><a class="tip"
                                                                                 href="${op.stitleImageIndex}"
                                                                                 target="_blank">查看</a></c:if></td>
                            <td><c:if test="${not empty op.stitleImage}"><a class="tip" href="${op.stitleImage}"
                                                                            target="_blank">查看</a></c:if></td>
                            ...
                            <td>
                                ...
                                <a href="${ctx}/mgr/article/preview?pid=${op.isort}&nid=${op.snavigationId}"
                                   target="_blank">预览</a>&nbsp;&nbsp;
                                ...
                                <a href="javascript:void(0);" onclick="copyId('${op.id}')">复制</a>
                            </td>
                            </tr>
                        </c:forEach>
                    </c:if>
