...
public class Page<E> {
	...
	public String toString() {
		return "Page [pageNum=" + pageNum + ", pageSize=" + pageSize
				...
				+ total + ", pages=" + pages + ", count=" + count
				+ ", countSignal=" + countSignal + ", orderBy=" + orderBy
				+ ", orderByOnly=" + orderByOnly + ", reasonable=" + reasonable
				+ ", pageSizeZero=" + pageSizeZero + ", results=" + results
				+ "]";
	}
