                ...
                <div class="ibox-content">
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="sauditUser" id="sauditUser" value="" placeholder="审核人..."
                                       class="layui-input">
                            </div>
                        </div>
...
//                {name: 'ssecurityKey', index: 'SSECURITY_KEY', label: "安全密钥",width:260},
//                {name: 'sregPort', index: 'SREG_PORT', label: "注册端口",width:100},
        {
            name: 'istatus',
            index: 'ISTATUS',
            label: "注册码状态",
...
//                {name: 'tupdateTime', index: 'TUPDATE_TIME', label: "修改日期"},
    ...
    function editMethod(sid) {
        showLayerOne("编辑设备注册信息", ctx + '/device/register/toEdit?sid=' + sid);
    }
    function auditMethod(sid) {
        showLayerOne("审核设备注册信息", ctx + '/device/register/toAudit?sid=' + sid);
    }
</script>
</body>
</html>
