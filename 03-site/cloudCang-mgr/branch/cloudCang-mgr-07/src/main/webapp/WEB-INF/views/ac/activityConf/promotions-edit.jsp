    ...
    <form class="layui-form" action="${ctx}/activityConf/savePromotions" method="post" id="myForm">
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <cang:select type="list" name="iisSuperposition" id="iisSuperposition" disabled="disabled"
                                 value="${conf.iisSuperposition}" list="{0:否,1:是}"/>
                </div>
            </div>
        </div>
        <!--首单 -->
                ...
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="firstTargetMoney" id="firstTargetMoney" ignore="ignore"
                               ...
                               nullmsg="目标金额不能为空" errormsg="目标金额必须为数字" placeholder="(0不限制)"
                ...
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="firstDiscountAmount" id="firstDiscountAmount" ignore="ignore"
                               datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/"
                               nullmsg="优惠金额不能为空" errormsg="优惠金额必须为数字"
        ...
        <div style="display: none;" id="discount">
            <div class="layui-form-item">
                ...
                <div class="layui-col-md6">
                    <label class="layui-form-label">目标金额</label>
                    <div class="layui-input-inline">
                        <input type="text" name="discountTargetMoney" id="discountTargetMoney" placeholder="(0不限制)"
            ...
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="discountTargetNum" id="discountTargetNum" placeholder="(0不限制)"
                ...
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="fullReductionTargetNum" id="fullReductionTargetNum" ignore="ignore"
                               placeholder="(0不限制)" placeholder="(0不限制)" datatype="n" disabled="disabled"
                               errormsg="目标件数必须为数字" value="${confDetail.ftargetNum}" class="layui-input"/>
                    </div>
                </div>
            </div>
                ...
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="fdiscountLimit" id="fdiscountLimit" ignore="ignore"
                               placeholder="(0不限制)"
                               datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/"
                               nullmsg="优惠上限不能为空" errormsg="优惠上限必须为数字"
                ...
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="fullReductionTargetMoney1" id="fullReductionTargetMoney1"
                               placeholder="(0不限制)" ignore="ignore"
                               datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/"
                               nullmsg="优惠金额不能为空" errormsg="优惠金额必须为数字"
                ...
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="cashBackTargetMoney" id="cashBackTargetMoney" ignore="ignore"
                               placeholder="(0不限制)"
                               datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/"
                               nullmsg="目标金额不能为空" errormsg="目标金额必须为数字"
                               value="<fmt:formatNumber pattern="#0.##" value="${confDetail.ftargetMoney}" />"
                               class="layui-input"/>
                    </div>
                </div>
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="fcashBackMoney" id="fcashBackMoney" ignore="ignore"
                               datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/"
                               nullmsg="返现金额不能为空" errormsg="返现金额必须为数字"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="iallCount" datatype="n" nullmsg="请输入活动期间总参与次数" errormsg="参与次数必须数字"
                           id="iallCount"
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <cang:select type="dic" groupNo="SP000115" name="icountType" layFilter="countType"
                                 exp="datatype=\"*\" nullmsg=\"请选择参与次数限制类型\""
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label" id="allLabel">(<c:choose><c:when
                        test="${conf.icountType eq 10}">用户</c:when>
                    <c:when test="${conf.icountType eq 20}">设备</c:when><c:otherwise>限制类型</c:otherwise></c:choose>)总参与次数</label>
                <div class="layui-input-inline">
                    <input type="text" name="iuserAllCount" datatype="n" nullmsg="请输入(限制类型)总参与次数" errormsg="参与次数必须数字"
                           id="iuserAllCount"
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="iuserDayCount" datatype="n" nullmsg="请输入(限制类型)单日参与次数" errormsg="参与次数必须数字"
                           id="iuserDayCount"
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="irangeDevice" lay-filter="rangeDevice" value="0" <c:if
                            test="${conf.irangeType eq 10 || conf.irangeType == 30}"> checked</c:if> title="全部"/>
                    <input type="radio" name="irangeDevice" lay-filter="rangeDevice" value="1" <c:if
                            test="${conf.irangeType eq 20 || conf.irangeType == 40}"> checked</c:if> title="部分"/>
                </div>
            </div>
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="irangeCommodity" lay-filter="rangeCommodity" value="0" <c:if
                            test="${conf.irangeType eq 10 || conf.irangeType == 20}"> checked</c:if> title="全部"/>
                    <input type="radio" name="irangeCommodity" lay-filter="rangeCommodity" value="1" <c:if
                            test="${conf.irangeType eq 30 || conf.irangeType == 40}"> checked</c:if> title="部分"/>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <button class="layui-btn layui-btn-primary" id="selectDevice"
                        ...
                        test="${conf.irangeType eq 10 || conf.irangeType == 30}"> disabled="disabled"</c:if>>选择设备
                </button>
            </div>
            <div class="layui-col-md6">
                ...
                <button class="layui-btn layui-btn-primary" id="selectCommodity"
                        style="margin-left: 200px;margin-top: 10px;" type="button" <c:if
                        test="${conf.irangeType eq 10 || conf.irangeType == 20}"> disabled="disabled"</c:if>>选择商品
                </button>
            </div>
        </div>
        <div class="layui-form-item mt13">
            ...
            <div class="layui-input-block block_textarea">
                <textarea class="layui-textarea layui-form-textarea80p" datatype="*" nullmsg="请输入活动描叙" id="sdescription"
    ...
    $(function () {
        ...
        $("#selectDevice").click(function () {
            ...
            if (!isEmpty(deviceIds)) {
                showLayerMax("选择设备信息", ctx + "/common/selectDevice?deviceIds=" + deviceIds + "&deviceCodes=" + deviceCodes + "&allIstatus=20");
            } else {
