    ...
    <form class="layui-form" action="${ctx}/paramGroupDetail/${groupNo}/save" method="post" id="myForm">
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sname" datatype="*" nullmsg="请输入参数名称"  id="sname"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="svalue" id="svalue" value="${parameterGroupDetail.svalue}" datatype="*" nullmsg="请输入参数值"
                           class="layui-input"/>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="sremark" name="sremark" class="layui-textarea layui-form-textarea80p"
                          placeholder="说明（非必填项）">${parameterGroupDetail.sremark}</textarea>
            </div>
        </div>
