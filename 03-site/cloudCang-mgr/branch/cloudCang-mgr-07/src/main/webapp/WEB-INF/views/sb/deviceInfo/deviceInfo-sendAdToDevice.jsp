...
<form class="layui-form" action="${ctx}/device/saveNewsUpdate" method="post" id="myForm">
    <div class="col-sm-12">
        <div class="ibox-content m-t">
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="radio" name="newsType"  value="10"  checked title="设备广告"/>
                        <%--<input type="radio" name="newsType"  value="20"  title="系统公告"/>--%>
                    </div>
                </div>
                <div class="layui-col-md6">
                    <label class="layui-form-label">资讯运营位</label>
                    <div class="layui-input-inline">
                        <select lay-verify="required" lay-search="" name="sregionCode" datatype="*" nullmsg="请选择资讯运营位"
                                id="sregionCode" class="state" lay-filter="sregionCode">
                            <option value="">请选择资讯运营位</option>
            ...
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label">更新设备</label>
                    <div class="layui-input-inline">
    ...
    $(function () {
        ...
        $("#selectDevice").click(function() {
            ...
            if (!isEmpty(deviceIds)) {
                showLayerMax("选择设备信息",ctx+"/common/selectDevice?queryDeviceType=100&deviceIds="+deviceIds+"&deviceCodes="+deviceCodes);
            } else {
                showLayerMax("选择设备信息",ctx+"/common/selectDevice?queryDeviceType=100");
            }
        });
