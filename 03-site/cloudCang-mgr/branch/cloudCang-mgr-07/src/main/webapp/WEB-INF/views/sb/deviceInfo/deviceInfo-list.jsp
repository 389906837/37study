                ...
                <div class="ibox-content">
                    <div class="layui-form" id="searchForm" style="margin-bottom:13px;">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="sputAddress" id="sputAddress" value="" placeholder="投放地址..."
                                       class="layui-input">
                            </div>
                            <div class="layui-input-inline">
                                <input type="text" name="sgroupName" id="sgroupName" value="" placeholder="设备分组..."
                                       class="layui-input">
                            </div>
                        ...
                        <div class="layui-form-item" style="margin-bottom: 10px;">
                            ...
                            <shiro:hasPermission name="DEVICE_INFO_VOLUME">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="volume"><i
                                        class="layui-icon">&#xe645;</i>音量
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_INVENTORY">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="inventory"><i
                                        class="layui-icon">&#xe63c;</i>盘货
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_UPGRADEVOICE">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="upgradeVoice"><i
                                        class="layui-icon">&#xe645;</i>升级语音
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_SYSTEMUPGRADE">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="systemUpgrade"><i
                                        class="layui-icon">&#xe631;</i>APK升级
                                </button>
                            </shiro:hasPermission>
                            ...
                            <shiro:hasPermission name="DEVICE_INFO_SHUTDOWN">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="shutdown"><i
                                        class="layui-icon">&#xe631;</i>关机
                                </button>
                            </shiro:hasPermission>
                            ...
                            <shiro:hasPermission name="DEVICE_INFO_DEVICEGROUP">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="deviceGroup"><i
                                        class="layui-icon">&#xe63c;</i>分组
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_UNREGISTER">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="unRegistered"><i
                                        class="layui-icon">&#xe60b;</i>未注册
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_REGISTER">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="registered"><i
                                        class="layui-icon">&#xe62c;</i>已注册
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_VR_SERVER_UPGRADE">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="vrServerUpgrade"><i
                                        class="layui-icon">&#xe628;</i>视觉服务器更新
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_VR_LIB_UPGRADE">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="vrLibUpgrade"><i
                                        class="layui-icon">&#xe615;</i>视觉库更新
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_SEND_AD">
                                <button class="layui-btn layui-btn-sm layui-btn-hui" data-type="sendAdToDevice"><i
                                        class="layui-icon">&#xe609;</i>推送广告
                                </button>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="DEVICE_INFO_BATCH_REALTIME_SWITCH">
                                <button class="layui-btn layui-btn-sm layui-btn-hui"
                                        data-type="sendRealTimeReplentshment"><i class="layui-icon">&#xe60e;</i>实时购物车
                                </button>
                            </shiro:hasPermission>
...
<script type="text/javascript">
    var colModel = [
        ...
        {
            name: 'ioperateStatus',
            index: 'IOPERATE_STATUS',
            label: "运营状态",
            formatter: "select",
            editoptions: {value: '10:启用;20:停用'},
            width: 80
        },
        {
            name: 'istandardStockStatus',
            label: "标准库存状态",
            formatter: "select",
            editoptions: {value: '10:启用;20:关闭'},
            width: 100,
            sortable: false
        },
        {
        ...
        },
        {
            ...
            label: "系统对接类型",
            formatter: "select",
            editoptions: {value: '10:自主研发;20:第三方'},
            width: 100
        },
        {
            name: 'iscreenDisplayType',
            index: 'ISCREEN_DISPLAY_TYPE',
            label: "屏幕显示类型",
            formatter: "select",
            editoptions: {value: '10:横屏;20:竖屏'},
            width: 100
        },
        /*{
         name: 'icontainerType',
    ...
    function tableCallBack() {
        setTimeout(function () {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                <shiro:hasPermission name="DEVICE_QUERY_ADVERTISEMENT">
                str += "<img src='${staticSource}/resources/images/oper_icon/chakanguanggao.png' class=\"oper_icon\" onclick=\"viewAdvMethod('"
                    + cl + "')\" title='查看设备广告信息' alt='查看设备广告信息'  /> | ";
                </shiro:hasPermission>
    ...
    layui.use('form', function () {
        var $ = layui.$, active = {
            ...
            disabled: function () {//停用
                ...
                confirmOperTip("确定要操作停用设备?", ctx + "/device/info/operate/disabled", {
                    checkboxId: sid.join(","),
                    method: "disabled"
                });
            },
    ...
    function viewAdvMethod(sid) {
        showLayerMax("设备广告管理", ctx + '/device/info/toAdvertis?sid=' + sid);
    }
</script>
</body>
</html>
