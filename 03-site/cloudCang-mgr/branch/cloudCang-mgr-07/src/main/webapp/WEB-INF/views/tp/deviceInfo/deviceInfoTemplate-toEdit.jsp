            ...
            <form class="layui-form" action="${ctx}/deviceInfoTemplate/edit" method="post" id="myForm">
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="dic" name="itype" id="itype" entire="true" layFilter="itype"
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="isupportWeigh" id="isupportWeigh" entire="true" layFilter="supportWeigh"
                                         value="${deviceInfoTemplate.isupportWeigh}" list="{0:否,1:是}"/>
                        </div>
                    </div>
                    <c:if test="${ deviceInfoTemplate.itype != 50 and deviceInfoTemplate.itype != 60}">
                    <div class="layui-col-md6" style="display: none;" id="recognitionModelCode">
                        </c:if>
                        <c:if test="${ deviceInfoTemplate.itype == 50 or deviceInfoTemplate.itype == 60}">
                        <div class="layui-col-md6" id="recognitionModelCode">
                            ...
                            <div class="layui-input-inline" style="width: 115px">
                                <input type="text" name="srecognitionModelCode" readonly="true"
                                       ...
                                       value="${deviceInfoTemplate.srecognitionModelCode}"
                                       class="layui-input"/>
                            </div>
                            <button class="layui-btn" id="btn2" style="float: left;" type="button"
                                    data-type="sel2">选择
                            </button>
                        </div>
                </div>
                <div class="layui-form-item" style="display:none;" name="iweightDiv" id="iweightDiv">
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="dic" name="iweightType" id="iweightType"
                                         value="${deviceInfoTemplate.iweightType}"
                                         layFilter="weightType" entire="true" groupNo="SP000177"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-col-md6">
                            ...
                            <div class="layui-input-inline">
                                <cang:select type="list" name="iisBindTrash" id="iisBindTrash"
                                             entire="true" value="${deviceInfoTemplate.iisBindTrash}"
                                             list="{0:否,1:是}"/>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
            if (${1 == deviceInfoTemplate.isupportWeigh }) {
