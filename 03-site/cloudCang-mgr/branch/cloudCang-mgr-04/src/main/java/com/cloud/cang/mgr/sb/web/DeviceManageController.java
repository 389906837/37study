        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (deviceManageDomain != null) {
                    ...
                    //操作日志
                    String logText = MessageFormat.format("查询设备管理（负责人）信息，编号{0}", deviceManageDomain.getScode());
        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (deviceManageDomain != null) {
                    ...
                    //操作日志
                    String logText = MessageFormat.format("查询设备管理（负责人），设备编号{0}", deviceManageDomain.getScode());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
    ...
    ResponseVo<DeviceManage> manageEdit(DeviceManage deviceManage) {
        try {
            ...
            if (StringUtils.isNotBlank(id) && StringUtils.isNotBlank(sbId)) {
                ...
                if (null != deviceInfo) {
                    String logText = MessageFormat.format("编辑设备管理（负责人）信息，设备编号为{0}", deviceInfo.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo("编辑设备管理（负责人）信息service异常");
    }
    /* ----------1.设备管理（负责人）信息结束 ----------*/
