                ...
                <div class="layui-form-item wflayui-form-item">
                    ...
                    <table cellspacing="0" border="0">
                        ...
                        <tr>
                            ...
                            <td class="text-left" style="width:18%">微信代扣方式：</td>
                            <td class="text-right" style="width:32%">
                                <c:if test="${wCmerchantConf.iwechatWithholdType == 10 }">微信免密代扣</c:if>
                                <c:if test="${wCmerchantConf.iwechatWithholdType == 20 }">微信支付分代扣</c:if>
                        </tr>

                        <tr>
                            <td class="text-left">微信服务ID：</td>
                            <td class="text-right">
                                ${wCmerchantConf.sserviceId}
                            </td>
                            <td class="text-left">微信APIV3私钥地址：</td>
                            <td class="text-right">
                                ${wCmerchantConf.swechatPrivateKeyUrl}
                            </td>
                        </tr>

                        <tr>
                            <td class="text-left">微信APIV3密钥：</td>
                            <td class="text-right">
                                ${wCmerchantConf.swechatApiv3Key}
                            </td>
                            <td class="text-left">微信APIV3证书序列号：</td>
                            <td class="text-right">
                                ${wCmerchantConf.swechatApiv3CertNumber}
                            </td>
                        </tr>
                        <tr>
                            <td class="text-left">微信支付分APPID：</td>
                            <td class="text-right">
                                ${wCmerchantConf.swechatPointAppid}
                            </td>
                            <td class="text-left">微信支付分MD5秘钥：</td>
                            <td class="text-right">
                                ${wCmerchantConf.swechatPointAppSecret}
                            </td>
                        </tr>
                        <tr>
