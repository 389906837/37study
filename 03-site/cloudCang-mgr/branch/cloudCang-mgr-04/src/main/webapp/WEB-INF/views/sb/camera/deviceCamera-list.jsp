                ...
                <div class="ibox-content">
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="sport" id="sport" value="" placeholder="端口号..."
                                       class="layui-input">
                            </div>
                            <div class="layui-input-inline">
                                <input type="text" name="sserialNumber" id="sserialNumber" value="" placeholder="序列号..."
                                       class="layui-input">
                            </div>
                            <div class="layui-input-inline">
...
<script type="text/javascript">
    ...
    var colModel = [
        ...
        {name: 'sserialNumber', index: 'SSERIAL_NUMBER', label: "序列号", width: 120},
        {name: 'sweightCode', index: 'SWEIGHT_CODE', label: "称重编号", width: 120},
    ...
    function editMethod(sid) {
        showLayerMedium("编辑网络摄像头配置信息", ctx + '/cameraConfig/toEdit?sdeviceId=' + sdeviceId + "&sid=" + sid);
    }
