...
<script type="text/javascript">
    ...
    function viewMethod(sid) {
        showLayerMedium("模板详情", ctx + '/deviceInfoTemplate/view?sid=' + sid);
    }
    function editMethod(sid) {
        showLayerMedium("编辑模板信息", ctx + '/deviceInfoTemplate/toEdit?sid=' + sid);
    }
    function delMethod(sid) {
        confirmDelTip("确定要删除数据?", ctx + "/deviceInfoTemplate/delete", {checkboxId: sid});
    }
    function disableMethod(sid) {
        confirmOperTip("确定要停用该模板?", ctx + "/deviceInfoTemplate/changeStatus", {checkboxId: sid});
    }
    function enableMethod(sid) {
        confirmOperTip("确定要启用该模板?", ctx + "/deviceInfoTemplate/changeStatus", {checkboxId: sid});
    }
</script>
</body>
</html>
