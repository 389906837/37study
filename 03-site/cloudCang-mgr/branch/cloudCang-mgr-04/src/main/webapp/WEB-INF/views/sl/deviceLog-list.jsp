                ...
                <div class="ibox-content">
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <input type="text" name="adress" id="adress" value="" placeholder="设备地址..." class="layui-input">
                            </div>
                            <div class="layui-inline">
                            ...
                            <div class="layui-inline">
                                <input type="text" name="topenTimeStr" id="topenTimeStr" placeholder="开门时间" class="layui-input">
                            </div>
                            <div class="layui-inline">
                                <input type="text" name="tcloseTimeStr" id="tcloseTimeStr" placeholder="关门时间" class="layui-input">
                            </div>
                            <div class="layui-inline">
