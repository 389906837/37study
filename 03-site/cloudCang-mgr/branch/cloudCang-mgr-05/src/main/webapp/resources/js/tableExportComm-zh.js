...
function addExportBtn1(fileName) {
    exportFileName = fileName;
    $("#gridTable").jqGrid('navButtonAdd','#gridPager',{
        position:'last',title:'导出表格数据',buttonicon:"glyphicon-download-alt",caption:'',onClickButton:exportExcel1
    });
}

function addExportBtnByUrl(url) {
    $("#gridTable").jqGrid('navButtonAdd','#gridPager',{
        position:'last',title:'导出表格数据',buttonicon:"glyphicon-download-alt",caption:'',onClickButton:function() {
