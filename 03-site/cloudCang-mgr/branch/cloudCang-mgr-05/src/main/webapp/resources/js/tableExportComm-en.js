...
function addExportBtn(fileName) {
    ...
    $("#gridTable").jqGrid('navButtonAdd','#gridPager',{
        position:'last',title:'Export table data',buttonicon:"glyphicon-download-alt",caption:'',onClickButton:exportExcel
    });
}
...
function addExportBtn1(fileName) {
    exportFileName = fileName;
    $("#gridTable").jqGrid('navButtonAdd','#gridPager',{
        position:'last',title:'Export table data',buttonicon:"glyphicon-download-alt",caption:'',onClickButton:exportExcel1
    });
}

function addExportBtnByUrl(url) {
    $("#gridTable").jqGrid('navButtonAdd','#gridPager',{
        position:'last',title:'Export table data',buttonicon:"glyphicon-download-alt",caption:'',onClickButton:function() {
...
function exportExcel() {
    showLayer("Export configuration", ctx + '/common/exportConfig');
}


function exportExcel1() {
    showLayer("Export configuration", ctx + '/common/exportConfigs');
}
