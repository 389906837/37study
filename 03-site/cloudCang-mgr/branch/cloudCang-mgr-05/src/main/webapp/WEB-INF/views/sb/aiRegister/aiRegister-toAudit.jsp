...
<div class="ibox-content">
    <form class="layui-form" action="${ctx}/ai/aiRegister/audit" method="post" id="myForm">

        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code="sb.audit.status" /></label>
                <div class="layui-input-inline">
                    <%--<cang:select type="list" name="istatus" id="istatus" entire="true" value="${deviceRegisterDomain.istatus}"  list="{10:springMessageCode=sb.check.pending'/>
,20:springMessageCode=sb.approved'/>
,30:springMessageCode=sb.Audit.rejection'/>
}"/>--%>
                    <cang:select type="list" name="istatus" exp="springMessageCode=sb.please.select.the.audit.status" layFilter="istatus"
                                 id="istatus" entire="true" value="${aiRegisterDomain.istatus}"  list='{20:springMessageCode=main.approval,30:springMessageCode=main.rejection}'/>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="sremark" name="sremark" class="layui-textarea layui-form-textarea80p"
                          placeholder='<spring:message code="sb.when.reviewing.rejection" /><spring:message code="main.required" />...'>${aiRegisterDomain.sremark}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-md6">
