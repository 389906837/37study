            ...
            <form class="layui-form" action="${ctx}/deviceModelTemplate/add" method="post" id="myForm" >
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="ielectricShock" id="ielectricShock" entire="true"
                                         value="" list="{10:springMessageCode=tp.class,20:springMessageCode=tp.class.i,30:springMessageCode=tp.class.ii,40:springMessageCode=tp.class.iii}"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="icompressorNum" id="icompressorNum" value="" class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="scontrastMode" id="scontrastMode" entire="true"
                                         value="" list="{rawstock:springMessageCode=tpmodel.original.stock,openDoor:springMessageCode=tpmodel.switch.door}"/>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
