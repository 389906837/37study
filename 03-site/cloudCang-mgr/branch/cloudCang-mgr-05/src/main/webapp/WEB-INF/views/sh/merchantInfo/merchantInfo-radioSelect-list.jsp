                ...
                <div class="ibox-content">
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="sname" id="sname" value="" placeholder='<spring:message code="sm.merchant.name" />'
                                       class="layui-input">
                            </div>
                           <%-- <div class="layui-input-inline">
    ...
    $(function () {
        ...
        $("#gridTable").jqGrid({
            ...
            colModel: [{name: 'id', index: 'id', hidden: true},
                {name: 'scode', index: 'SCODE', label: '<spring:message code="main.merchant.number" />'},
                {name: 'sname', index: 'sname', label: '<spring:message code="sm.merchant.name" />'},
                {
                    name: 'itype',
                    index: 'itype',
                ...
                },
                {
                    name: 'istatus',
                    index: 'istatus',
                    label: '<spring:message code="sh.company.status" />',
                    formatter: "select",
