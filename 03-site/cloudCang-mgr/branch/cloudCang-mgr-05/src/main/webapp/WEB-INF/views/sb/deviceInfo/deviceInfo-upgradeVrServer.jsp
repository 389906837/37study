...
<body class="gray-bg">
<form class="layui-form" action="${ctx}/device/info/updateVrServer" method="post" id="myForm">
    <div class="col-sm-12">
        <div class="ibox-content m-t">
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"><spring:message code='sb.upgrade.package.address' /></label>
                    <div class="layui-input-inline">
                        <input type="text" name="url" id="url" placeholder='<spring:message code="main.required" />...' datatype="*" nullmsg="<spring:message code='sb.please.enter.the.upgrade.address' />" value="" class="layui-input"/>
                    </div>
                </div>
                <div class="layui-col-md6">
