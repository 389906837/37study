...
<div class="ibox-content">
    <form class="layui-form" action="${ctx}/orderAudit/save" method="post" id="myForm" onsubmit="return false;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.total.order' /></label>
                <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="shandlerRemark" name="shandlerRemark" class="layui-textarea layui-form-textarea80p"
                          placeholder='<spring:message code="main.remarks" />（<spring:message code="main.not.required" />）'>${orderAudit.shandlerRemark}</textarea>
            </div>
        </div>
        <div class="wfsplitt">
