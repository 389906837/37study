...
<script type="text/javascript">
    ...
    var colModel =[
        ...
        {name: 'sdealwithMan', index: 'SDEALWITH_MAN', label: "<spring:message code='main.handler' />",width:120,sortable : false},
        {name: 'istatus',index: 'istatus',label: '<spring:message code="main.state" />',formatter: "select", editoptions: {value: '10:<spring:message code="main.to.be.processed" />;20:<spring:message code='sb.processed' />'},width:100,sortable : false},
