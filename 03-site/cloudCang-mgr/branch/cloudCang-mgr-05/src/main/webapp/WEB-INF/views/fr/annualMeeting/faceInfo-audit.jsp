    ...
    <form class="layui-form" action="${ctx}/annualMeetingFaceInfo/audit" method="post" id="myForm"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="srealName" datatype="*" nullmsg="<spring:message code='fr.please.enter.user.name' />" id="srealName" value="${faceRegInfo.srealName}"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <cang:select type="list" name="iauditStatus" exp="springMessageCode=sb.please.select.the.audit.status" layFilter="iauditStatus"
                                 id="iauditStatus" entire="true" value="${faceRegInfo.iauditStatus}"  list='{20:springMessageCode=main.approval,30:springMessageCode=main.rejection}'/>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="sauditRemark" name="sauditRemark" class="layui-textarea layui-form-textarea80p"
                          placeholder='<spring:message code="sb.when.reviewing.rejection" /><spring:message code="main.required" />...'></textarea>
            </div>
        </div>
