	...
	public void delete(String[] checkboxId) {
		for (String id:checkboxId) {
			...
			if (mbrPurview != null){
				...
				//操作日志
				String logText= MessageFormat.format(MessageSourceUtils.getMessageByKey("log.hy.delete.purview")+MessageSourceUtils.getMessageByKey("main.name",null)+"{0},"+ MessageSourceUtils.getMessageByKey("main.code",null)+"{1}",mbrPurview.getSpurName(),mbrPurview.getSpurNo() );
