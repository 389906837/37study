        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (deviceModel != null) {
                    ...
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.query.device.detail"), deviceInfo.getScode());
        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (deviceModel != null) {
                    ...
                    //操作日志
                    DeviceInfo deviceInfo = deviceInfoService.selectByPrimaryKey(deviceModel.getSdeviceId());
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.device.detail.button"), deviceInfo.getScode());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
    ...
    ResponseVo<DeviceModel> deviceModelEdit(DeviceModel deviceModel, HttpServletRequest request) {
        try {
            ...
            if (StringUtils.isNotBlank(id) && StringUtils.isNotBlank(sbId)) {
                ...
                if (null != deviceInfo) {
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.edit.device.details="), deviceInfo.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.model.edit.service.error"));
    }
