        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (deviceRegisterDomain != null) {
                    ...
                    //操作日志
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.query.device.register.info"), deviceRegisterDomain.getScode());
        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (deviceRegisterDomain != null) {
                    ...
                    //操作日志
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.ai.device.register.audit.button"), deviceRegisterDomain.getScode());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
    ...
    ResponseVo<String> audit(DeviceRegister deviceRegister) {
        try {
            ...
            if (StringUtils.isNotBlank(deviceRegister.getSdeviceId())) {
                ...
                if (null != deviceInfo) {
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.review.device.registration.information"), deviceInfo.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.register.audit.error"));
    }
        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (deviceRegisterDomain != null) {
                    ...
                    modelMap.put("deviceRegisterDomain", deviceRegisterDomain);
                    //操作日志
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.edit.device.registration.information"), deviceRegisterDomain.getScode());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
    ...
    public @ResponseBody ResponseVo<String> registerEdit(DeviceRegister deviceRegister) {
        try {
            ...
            if (StringUtils.isNotBlank(deviceRegister.getSdeviceId())) {
                DeviceInfo deviceInfo = deviceInfoService.selectByPrimaryKey(deviceRegister.getSdeviceId());
                if (null != deviceInfo) {
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.edit.device.register.code"), deviceInfo.getScode());
                    LogUtil.addOPLog(LogUtil.AC_EDIT, logText, null);
                }
            }
            return ResponseVo.getSuccessResponse("success");
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.register.eidt.service.error"));
    }
