    ...
    public String upgradeToView(String sid,ModelMap map) {
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                map.put("smainId", sid);
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.query.upgrade.record.detail"), "");
    ...
    public String upgradeDetailsToView(String sid,ModelMap map) {
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.query.device.upgrade.record.detail"), deviceUpgradeDetailsDomain.getSdeviceCode());
                LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
