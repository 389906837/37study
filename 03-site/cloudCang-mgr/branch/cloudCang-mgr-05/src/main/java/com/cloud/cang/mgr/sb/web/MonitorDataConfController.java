        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (monitorDataConfDomain != null) {
                    ...
                    //操作日志
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.query.device.monitor"), monitorDataConfDomain.getScode());
        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (monitorDataConfDomain != null) {
                    ...
                    //操作日志
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.to.edit.device.monitor"), monitorDataConfDomain.getScode());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
    ...
    ResponseVo<MonitorDataConf> monitorDataConfEdit(MonitorDataConf monitorDataConf) {
        try {
            ...
            if (StringUtils.isNotBlank(id) && StringUtils.isNotBlank(sbId)) {
                ...
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.edit.device.monitor"), deviceInfo.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.monitor.config.service.edit"));
    }
