        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != faceRegisterInfo) {
                    ...
                    String logText4 = MessageFormat.format(MessageSourceUtils.getMessageByKey("con.fr.vfifn", null), faceRegisterInfo.getSfaceCode());
    ...
    public ResponseVo<String> delete(String[] checkboxId) {
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("con.fr.dfrifn", null), responseVo.getData().toString());
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("con.fr.tsadtfri", null));
        }
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("con.fr.tsadtfrif", null));
    }
