...
//        commodityVo.setIstatus(10);
    ...
    ResponseVo<List<Category>> getsCategoryByParentId(String pid) {
        if (StringUtils.isNotBlank(pid)) {
            ...
            if (CollectionUtils.isNotEmpty(smallCategoryList)) {
                ...
                return new ResponseVo<>(false, 111, MessageSourceUtils.getMessageByKey("spcon.commodity.query.error",null));
            }
        }
        logger.debug("<===根据父类ID查询小类出错===>");
        return new ResponseVo<>(false, 111, MessageSourceUtils.getMessageByKey("spcon.commodity.parent.query.error",null));
    }
    ...
    public ResponseVo<CommodityInfo> commodityAdd(@RequestParam(value = "file", required = false) MultipartFile scommodityImgfile, CommodityInfo commodityInfo, String skuId) {
        ...
        try {
                ...
                if (StringUtils.isBlank(commodityCode) || StringUtils.isBlank(merchantCode) || StringUtils.isBlank(merchantId)) {
                    return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("spcon.add.commodity.error",null));
                }
                ...
                if (StringUtils.isNotBlank(skuId)) {    //视觉商品
                    ...
                    if (commoditySku != null) {
                        ...
                        if (CollectionUtils.isNotEmpty(commodityInfoTemp)) {
                            return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo(MessageSourceUtils.getMessageByKey("spcon.add.commodity.code.exist",null));
                        }
                    ...
                    if (StringUtils.isBlank(commodityName)) {
                        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.product.name.empty",null));
                    }
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("spcon.add.commodity.log",null), commodityInfo.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("spcon.add.commodity.exception",null));
    }
    ...
    ResponseVo<String> groupManageDelete(String[] checkboxId) {
        ...
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("spcon.delete.commodity.log",null), "");
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("spcon.delete.commodity.error",null));
    }
    ...
    ResponseVo<String> groupManageShelf(String[] checkboxId) {
        ...
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("spcon.shelf.commodity.log",null)+"，"+ MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", responseVo.getData());
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("spcon.shelf.commodity.error",null));
    }
    ...
    ResponseVo<String> groupManageDropOff(String[] checkboxId) {
        ...
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("spcon.obtained.commodity.log",null)+"，"+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", responseVo.getData());
                LogUtil.addOPLog(LogUtil.AC_EDIT, logText, null);
                return responseVo;
            }
        } catch (ServiceException e) {
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("spcon.obtained.commodity.error",null));
    }
        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != commodityInfo) {
                    ...
                    map.put("commodityInfo", commodityInfo);
                    String logText4 = MessageFormat.format(MessageSourceUtils.getMessageByKey("spcon.view.commodity.log",null)+"，"+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", commodityInfo.getScode());
    ...
    ResponseVo<String> infotoEdit(@RequestParam(value = "file", required = false) MultipartFile file, CommodityInfo commodityInfo) {
        ...
        if (StringUtils.isNotBlank(sid)) {
            try {
                ...
                if (BooleanUtils.isTrue(responseVo.isSuccess())) {
                    String logText1 = MessageFormat.format(MessageSourceUtils.getMessageByKey("spcon.modify.commodity.log",null)+"，"+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", responseVo.getData());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("spcon.modify.commodity.error",null));
    }
    ...
    public void downloadExcel(HttpServletRequest request, HttpServletResponse response, CommodityVo commodityVo) {
        ...
        e.createRow(0);
        String[] names = new String[]{MessageSourceUtils.getMessageByKey("main.serial.number",null),MessageSourceUtils.getMessageByKey("main.product.number",null), MessageSourceUtils.getMessageByKey("main.product.name",null), MessageSourceUtils.getMessageByKey("main.visual.product.number",null),MessageSourceUtils.getMessageByKey("spcon.commodity.visual.number",null), MessageSourceUtils.getMessageByKey("spcon.commodity.label.name",null),MessageSourceUtils.getMessageByKey("spcon.commodity.big.category",null),
                MessageSourceUtils.getMessageByKey("spcon.commodity.small.category",null),MessageSourceUtils.getMessageByKey("spcon.commodity.cost.price",null),MessageSourceUtils.getMessageByKey("spcon.commodity.market.price",null),MessageSourceUtils.getMessageByKey("spcon.commodity.sale.price",null),MessageSourceUtils.getMessageByKey("spcon.commodity.unit",null),MessageSourceUtils.getMessageByKey("spcon.commodity.shelf.life",null),MessageSourceUtils.getMessageByKey("spcon.commodity.packaging.material",null),MessageSourceUtils.getMessageByKey("spcon.commodity.place.origin",null),
        MessageSourceUtils.getMessageByKey("spcon.commodity.barcode",null),MessageSourceUtils.getMessageByKey("spcon.commodity.status",null),MessageSourceUtils.getMessageByKey("spcon.commodity.short.name",null),MessageSourceUtils.getMessageByKey("main.merchant.number",null),MessageSourceUtils.getMessageByKey("main.merchant.name",null)};
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if(type.equals("10")){
                e.setCell(12, String.valueOf(obj.get("ISHELF_LIFE")) + MessageSourceUtils.getMessageByKey("vrsku.day"));
            }else {
                e.setCell(12, String.valueOf(obj.get("ISHELF_LIFE"))+ MessageSourceUtils.getMessageByKey("vrsku.month"));
            }
            if(type.equals("null")){
            ...
            if(status.equals("10")){
                e.setCell(16, String.valueOf(MessageSourceUtils.getMessageByKey("main.normal",null)));
            }else {
                e.setCell(16, String.valueOf(MessageSourceUtils.getMessageByKey("main.obtained",null)));
            }
            ...
            e.setCell(18, String.valueOf(obj.get("SMERCHANT_CODE")));
            e.setCell(19, String.valueOf(obj.get("MERCHANT_NAME")));

        }
        e.downloadExcel(request, response, MessageSourceUtils.getMessageByKey("spcon.commodity.list",null)+"-" + DateUtils.getCurrentDTimeNumber() + ".xls");
    }
}
