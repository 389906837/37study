...
public class RegionController {
    ...
    ResponseVo<Region> save(Region region) {
        ...
        if (StringUtils.isBlank(region.getId())) {
            ...
            //操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("wzcon.add.operating.area",null)+","+MessageSourceUtils.getMessageByKey("main.name",null)+"{0},"+ MessageSourceUtils.getMessageByKey("main.code",null)+"{1}", region.getSregionName(), region.getScode());
            ...
            //操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("wzcon.modify.operating.area",null)+"{0},"+MessageSourceUtils.getMessageByKey("main.code",null)+"{1}", region.getSregionName(), region.getScode());
