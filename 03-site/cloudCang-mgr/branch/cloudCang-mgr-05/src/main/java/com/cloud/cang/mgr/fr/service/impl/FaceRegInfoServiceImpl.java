...
//                    faceRegInfoVo.setItype(20);
    ...
    public ResponseVo<FaceRegInfo> updateFaceInfoByAudit(FaceRegInfo faceRegInfo) {
        ...
        if (null == faceRegInfoDomain) {
            errorResponseVo.setMsg(MessageSourceUtils.getMessageByKey("con.fr.uidne", null));
        ...
        if (iauditStatus == 20) {
            ...
            try {
                    ...
                    if (CollectionUtils.isNotEmpty(userDomainList)) {
                        ...
                        for (UserDomain u : userDomainList) {
                            ...
                            if (tempScore.compareTo(new Float(80)) == 1 && StringUtils.isNotBlank(userIdTemp)) {    // 阈值设置为80分
                                ...
                                errorResponseVo.setMsg(MessageSourceUtils.getMessageByKey("con.fr.uhrfi", null));
                                return errorResponseVo;
                            }
                        }
                    }
                ...
                throw new ServiceException(MessageSourceUtils.getMessageByKey("con.fr.aa", null));
            }
        } else {
            String sauditRemark = faceRegInfo.getSauditRemark();
            if (StringUtils.isBlank(sauditRemark)) {
                errorResponseVo.setMsg(MessageSourceUtils.getMessageByKey("con.fr.rrrrc", null));
                return errorResponseVo;
            }
            FaceRegInfo faceRegInfoVo = new FaceRegInfo();
            faceRegInfoVo.setTupdateTime(DateUtils.getCurrentDateTime());
        ...
        errorResponseVo.setMsg(MessageSourceUtils.getMessageByKey("con.fr.ftrfiitppctaotp", null));
        return errorResponseVo;
    }
    ...
    public ResponseVo<FaceRegInfo> insertFaceInfo(MultipartFile faceImg, FaceRegInfo faceRegInfo) {
        ...
        if (StringUtils.isBlank(faceCode)) {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("con.fr.aue", null));
        }
    ...
    public ResponseVo<String> batchImportFaceInfo(MultipartFile file) {
        ...
        if (null == workbook) {
            logger.error("工作薄不存在");
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("con.fr.wdne", null));
        }
        ...
        if (CollectionUtils.isEmpty(vrCommodityList)) {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("con.fr.itfriotamibtditufie", null));
        }
        ...
        for (int i = 0; i < vrCommodityList.size(); i++) {
            ...
            if (StringUtils.isBlank(srealName)) {
                ...
                errorStrBuf.append(MessageSourceUtils.getMessageByKey("con.fr.first", null) + serialNum + MessageSourceUtils.getMessageByKey("con.fr.ltnie", null));
                continue;
            }
            ...
            if (CollectionUtils.isNotEmpty(pictureDataList03)) {
                try {
                    ...
                    throw new ServiceException(MessageSourceUtils.getMessageByKey("con.fr.intbfuonuaa", null));
                }
            ...
            if (StringUtils.isBlank(faceCode)) {
                ...
                errorStrBuf.append(MessageSourceUtils.getMessageByKey("con.fr.first", null) + j +MessageSourceUtils.getMessageByKey("con.fr.lsn", null)
                        + serialNum + MessageSourceUtils.getMessageByKey("con.fr.sgine", null) );
                continue;
            }
        ...
        if (StringUtils.isNotBlank(errorStr)) {
            if (StringUtils.isNotBlank(correctStr)) {
                return new ResponseVo<>(false, ErrorCodeEnum.ERROR_COMMON_SYSTEM.getCode(), MessageSourceUtils.getMessageByKey("con.fr.sdwisatfdwi", null) + errorStr);
            }
            return new ResponseVo<>(false, ErrorCodeEnum.ERROR_COMMON_SYSTEM.getCode(), MessageSourceUtils.getMessageByKey("con.fr.aiftfdhae", null) + errorStr);
        }
