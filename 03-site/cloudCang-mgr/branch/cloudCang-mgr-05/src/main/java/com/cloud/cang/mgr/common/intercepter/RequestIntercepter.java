...
public class RequestIntercepter implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
        ...
        iCached.put("currentLocale", locale);
        ...
        //获取域名
        DomainConf domainConf = (DomainConf) iCached.get(request.getServerName());
        ...
        if (merchantInfo.getSparentId().equals("0") || 1 == merchantInfo.getIisParent()) {//根商户或者为父商户
            ...
            if (merchantInfo.getSparentId().equals("0")) {
                SessionUserUtils.getSession().setAttribute("SESSION_KEY_ROOT_MERCHANT_PARENT", 1);
            }
        }
