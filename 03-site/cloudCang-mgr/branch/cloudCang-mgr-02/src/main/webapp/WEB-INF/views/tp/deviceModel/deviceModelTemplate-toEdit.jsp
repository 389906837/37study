    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form" action="${ctx}/deviceModelTemplate/edit" method="post" id="myForm" >
                ...
                <input type="hidden" id="scameraMethod1" name="scameraMethod1" value="${deviceModelTemplate.scameraMethod}"/><%--摄像头方法--%>
                <div class="layui-form-item">
                    <div class="layui-col-md6">
                        <label class="layui-form-label">模板名称</label>
                        <div class="layui-input-inline">
                            <input type="text" name="sname" id="sname" datatype="*" nullmsg="请输入模板名称"
                                   value="${deviceModelTemplate.sname}" class="layui-input" placeholder="必填..."/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="ielectricShock" id="ielectricShock" entire="true"
                                         value="${deviceModelTemplate.ielectricShock}" list="{10:0类,20:I类,30:II类,40:III类}"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="iisUseExpandGpio" id="iisUseExpandGpio" entire="true"
                                         value="${deviceModelTemplate.iisUseExpandGpio}" list="{0:否,1:是}"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="iisDetectHall" id="iisDetectHall" entire="true"
                                         value="${deviceModelTemplate.iisDetectHall}" list="{0:否,1:是}"/>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="spcbModel" id="spcbModel" value="${deviceModelTemplate.spcbModel}"
                                   class="layui-input"/>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="scontrastMode" id="scontrastMode" entire="true"
                                         value="${deviceModelTemplate.scontrastMode}" list="{rawstock:原始库存,openDoor:开关门盘货}"/>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea id="sremark" name="sremark" class="layui-textarea layui-form-textarea80p"
                                  placeholder="备注（选填项）">${deviceModelTemplate.sremark}</textarea>
                    </div>
                </div>
