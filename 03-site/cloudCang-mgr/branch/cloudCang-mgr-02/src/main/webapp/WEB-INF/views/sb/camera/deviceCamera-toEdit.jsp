    ...
    <form class="layui-form" action="${ctx}/cameraConfig/edit"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sip" datatype="*" nullmsg="请输入IP" id="sip" value="${cameraConfig.sip}" class="layui-input"/>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sport" datatype="*" nullmsg="请输入端口号" id="sport" value="${cameraConfig.sport}"
                           class="layui-input"/>
                </div>
            </div>
        </div>
        <div class="layui-form-item m-t">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sserialNumber" datatype="*" nullmsg="请输入序列号" id="sserialNumber" value="${cameraConfig.sserialNumber}"
                           class="layui-input"/>
                </div>
            </div>
        </div>
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-block">
                    <textarea style="width: 470px" id="sremark" name="sremark"
                              class="layui-textarea layui-form-textarea80p" placeholder="非必填项">${cameraConfig.sremark}</textarea>
                </div>
            </div>
        </div>
