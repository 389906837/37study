    ...
    public ResponseVo<BrandInfo> commodityAdd(@RequestParam(value = "file", required = false) MultipartFile brandLogo, BrandInfo brandInfo) {
        ...
        try {
            ...
            if (StringUtils.isBlank(brandName)) {
                return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo("品牌名称不能为空");
            }
            // 查询品牌名是否存在
            ...
            if (CollectionUtils.isNotEmpty(brandInfoList)) {
                return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo("该品牌名称已经存在");
            }
            ...
            //操作日志
            String logText = MessageFormat.format("新增商品品牌，名称{0}", brandInfo.getSname());
        ...
        return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo("添加商品品牌信息出错");
    }
    ...
    public ResponseVo<String> brandInfoDelete(String[] checkboxId) {
        ...
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format("删除商品品牌信息", "");
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo("系统异常删除商品品牌信息失败！");
    }
    ...
    public String brandInfotoEdit(String sid, ModelMap map) {
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != brandInfo) {
                    map.put("brandInfo", brandInfo);
                    String logText4 = MessageFormat.format("商品品牌编辑按钮信息，品牌名称{0}", brandInfo.getSname());
    ...
    ResponseVo<BrandInfo> brandInfotoEdit(@RequestParam(value = "file", required = false) MultipartFile brandLogo, BrandInfo brandInfo) {
        ...
        if (StringUtils.isNotBlank(sid) && StringUtils.isNotBlank(brandInfo.getSname())) {
            try {
                ...
                //操作日志
                String logText1 = MessageFormat.format("修改商品品牌信息，名称{0}", brandInfo.getSname());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo("商品品牌不能为空！");
    }
        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != brandInfo) {
                    ...
                    String logText4 = MessageFormat.format("查看商品品牌信息，名称{0}", brandInfo.getSname());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText4, null);
