...
//        //只能查询自己供应商
    ...
    public void downloadExcel(HttpServletRequest request, HttpServletResponse response, ReplenishMentVo replenishMentVo) {
        ...
        e.createRow(0);
        String[] names = new String[]{"序号","补货单编号","商户编号","商户名称","设备编号","设备名称","设备地址","商品编号", "商品名称",
                "商品销售价","商品总额","补货数量","商品状态","补货状态","补货类型","补货员姓名","补货员手机号"};
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if(spStatus.equals("10")){
                e.setCell(12, String.valueOf("正常"));
            }
            if(spStatus.equals("20")) {
                e.setCell(12, String.valueOf("无效"));
            }
            if(istatus.equals("10")){
                e.setCell(13, String.valueOf("待配货"));
            }
            if(istatus.equals("20")){
                e.setCell(13, String.valueOf("配送中"));
            }
            if(istatus.equals("30")){
                e.setCell(13, String.valueOf("已完成"));
            }
            if(istatus.equals("40")){
                e.setCell(13, String.valueOf("取消配货"));
            }
            if(itype.equals("10")){
                e.setCell(14, String.valueOf("上架"));
            }else {
                e.setCell(14, String.valueOf("下架"));
            }
            e.setCell(15, String.valueOf(obj.get("SRENEWAL_NAME")));
            e.setCell(16, String.valueOf(obj.get("SRENEWAL_MOBILE")));
        }
        e.downloadExcel(request, response, "补货列表-" + DateUtils.getCurrentDTimeNumber() + ".xls");
    }
}
