...
public class GroupManageController extends GenericController {
    ...
    public PageListVo<List<GroupManageDomain>> queryData(GroupManageVo groupManageVo, ParamPage paramPage) {
        ...
        String queryCondition = operatorService.generatePurviewSql(operator, 50); //50 设备列表
    ...
    ResponseVo<GroupManage> groupManageAdd(GroupManage groupManage) {
        ...
        try {
            if (StringUtils.isNotBlank(sgroupName)) {
                ...
                //操作日志
                String logText = MessageFormat.format("增加设备分组信息，分组名称{0}", groupManage.getSgroupName());
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo("增加设备分组信息出错");
    }
    ...
    public @ResponseBody ResponseVo<String> groupManageDelete(String[] checkboxId) {
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format("删除设备分组信息", "");
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo("系统异常删除设备失败！");
    }
        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (groupManage != null) {
                    ...
                    //操作日志
                    String logText = MessageFormat.format("设备分组信息编辑按钮，分组名称{0}", groupManage.getSgroupName());
    ...
    public @ResponseBody ResponseVo<GroupManage> groupManageEdit(GroupManage groupManage) {
        try {
            ...
            if (StringUtils.isNotBlank(id) && StringUtils.isNotBlank(groupName)) {
                ...
                //操作日志
                String logText = MessageFormat.format("编辑设备分组信息，分组名称{0}", groupName);
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo("编辑设备分组service异常");
    }
        ...
        try {
            ...
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (groupManage != null) {
                    map.put("groupManage", groupManage);
                    //操作日志
                    String logText = MessageFormat.format("查询设备分组信息，分组名称{0}", groupManage.getSgroupName());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
    ...
    public @ResponseBody ResponseVo<String> checkDevice(String pid) {
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo("参数错误");
    }
