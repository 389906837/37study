...
public class OrderRecordController {
   ...
   /*     List<OrderRecordVo> orderRecordVoList = page.getResult();

        if (!hasPurCode("ORDER_MEMBER_NAME_DESENSITIZE")) {
            for (OrderRecordVo orderRecordVo : orderRecordVoList) {
                orderRecordVo.setSmemberName(DesensitizeUtil.mobilePhone(orderRecordVo.getSmemberName()));
            }
        }*/
