...
public class KeyWordsController {
    ...
    ResponseVo<KeyWords> save(KeyWords keyWords) {
        ...
        if (StringUtils.isBlank(keyWords.getId())) {
            ...
            // 操作日志
            String logText = MessageFormat.format("新增关键字名称{0},编号{1}", keyWords.getSpageName(), keyWords.getSpageNo());
            ...
            //操作日志
            String logText = MessageFormat.format("修改关键字名称{0},编号{1}", keyWords.getSpageName(), keyWords.getSpageNo());
