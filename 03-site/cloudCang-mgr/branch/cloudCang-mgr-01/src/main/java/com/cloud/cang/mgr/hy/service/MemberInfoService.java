...
public interface MemberInfoService extends GenericService<MemberInfo, String> {
     ...
     * @return ResponseVo
     */
    ResponseVo rechargeAgainUpData(SignResult signResult, HttpServletRequest request) throws Exception;
     ...
     * @return ResponseVo
     */
    ResponseVo WechantRechargeAgainUpData(WechatSignResult wechatSignResult,HttpServletRequest request) throws Exception;
