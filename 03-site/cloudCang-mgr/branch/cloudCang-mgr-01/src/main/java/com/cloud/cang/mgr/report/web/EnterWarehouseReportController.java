 ...
 */
@Controller
@RequestMapping("/enterWarehouseReport")
public class EnterWarehouseReportController {
    private static final Logger log = LoggerFactory.getLogger(EnterWarehouseReportController.class);
    @Autowired
    private ReportService reportService;

    @RequestMapping("/list")
    public String list() {
        return "report/enterWarehouse/enterWarehouseReport-list";
    }
    ...
    PageListVo<List<EnterWarehouseVo>> queryCommodityReport(ParamPage paramPage, EnterWarehouseReportDomain enterWarehouseReportDomain) {
        ...
        enterWarehouseReportDomain.setType(10);
