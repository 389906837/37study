...
public interface DeviceInfoService extends GenericService<DeviceInfo, String> {
     ...
     * @return
     */
    ResponseVo recordAndSendApkUpgradeMsg(String[] ids, String timeType, String version, String dproduceDate, String user, String irangeDevice, MultipartFile file, Integer upFileType, String localAddress);
     ...
     * @return
     */
    ResponseVo recordAndSendVrOsFeatureLibUpgradeMsg(String[] ids, String timeType, String url, String version, String dproduceDate, String user, String irangeDevice);
