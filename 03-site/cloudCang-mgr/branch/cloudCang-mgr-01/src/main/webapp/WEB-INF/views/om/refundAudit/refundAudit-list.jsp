            ...
            colModel: [{name: 'id', index: 'id', hidden: true},
                ...
                {name: 'spaySerialNumber', index: 'SPAY_SERIAL_NUMBER', label: "交易流水号", width: 260},
                {
                    ...
                    formatter: function(value, options, rowObject) {
                        ...
                        return '<span id="irefundStatus_'+rowObject.id+'" data="'+value+'" class="' + (({"10":"istatus-warm","20":"istatus-danger","30":"istatus-normal"})[value]) + '">' +  (({"10":"● 待退款","20":"● 退款失败","30":"● 退款成功"})[value])+ '</span>' }
                },
