...
<div class="ibox-content">
    <form class="layui-form" action="${ctx}/commodity/brandInfo/add"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sname" datatype="*" nullmsg="请输入品牌名称" id="sname" value=""
                           class="layui-input"/>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item m-t">
            <div class="layui-col-md6 ">
                ...
                <div class="layui-inline">
                    <button type="button" class="layui-btn" id="commonImgButton">选择品牌图片</button>
