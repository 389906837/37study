                    ...
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline" style="width: 210px">
                                <input type="text" name="queryTimeCondition" id="queryTimeCondition" placeholder="出库时间"
                                       class="layui-input">
                            </div>
...
<script src="${staticSource}/resources/js/tableExportComm.js?122"></script>
...
<script type="text/javascript">
    var colModel = [
        ...
        {name: 'orderCount', index: 'FORDER_COUNT', label: "出库数量", width: 150},
    ...
    $(function () {
        ...
        initTable(ctx + "/getOutWarehouseReport/queryData", colModel, function () {
            ...
            if (isExport) {//判断是否导出
                exportFileCallback1("出库汇总报表导出");
                isExport = false;
            }
            </shiro:hasPermission>
        }, config,loadCompleteFn);
        <shiro:hasPermission name="GETOUTWAREHOUSEREPORT_DOWNLOADEXCEL">
        addExportBtn1("出库汇总报表导出");
        </shiro:hasPermission>
    });
