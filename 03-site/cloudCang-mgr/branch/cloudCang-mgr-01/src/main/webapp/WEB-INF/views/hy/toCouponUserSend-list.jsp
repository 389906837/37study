...
<div class="layui-form-item fixed-bottom">
    <div class="layui-input-block">
        <label class="lable-left">已选 <i id="selectNums">${empty selectNums ? 0 : selectNums}</i> 个用户</label>
    ...
    $(function () {
        ...
        $("#gridTable").jqGrid({
            ...
            colModel: [{name: 'id', index: 'id', hidden: true},
                ...
                {name: 'smemberNameDesensitize', index: 'SMEMBER_NAME', label: "会员用户名", sortable: false},
                {name: 'snickName', index: 'SNICK_NAME', label: "会员昵称", sortable: false},
            ],
            pager: "#gridPager",
            viewrecords: true,
            sortname: "scode",
