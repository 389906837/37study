        ...
        <div class="ibox-content m-t">
            ...
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <a href="${staticSource}/resources/images/am07.xlsx" download="批量导入模板Excel07">批量导入模板Excel2007下载</a>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-inline">
                        <a href="${staticSource}/resources/images/am03.xls" download="批量导入模板Excel03">批量导入模板Excel2003下载</a>
                    </div>
                </div>
            </div>
        </div>
