    ...
    <form class="layui-form" action="${ctx}/couponBatch/save" method="post" id="myForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="dcouponExpiryDate" disabled="disabled" <%--datatype="*" nullmsg="请选择券失效时间"--%>
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline" style="width: 115px">
                    <input type="text" name="scommodityCode" id="scommodityCode" disabled="disabled" value="${couponBatch.suseLimitCommodity}" class="layui-input" />
                    <input type="hidden" name="scommodityId" id="scommodityId" value="${useCommodityIds}" class="layui-input" />
                </div>
                <button class="layui-btn" id="selectSp" style="display: inline-block;float: left;" type="button" disabled="disabled" data-type="sel">选择</button>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline" style="width: 260px">
                    <textarea class="layui-textarea" id="suseLimitCommodity" name="suseLimitCommodity" readonly="readonly" placeholder="空不限制">${couponBatch.suseLimitCommodity}</textarea>
                </div>
        ...
        <div class="layui-form-item" id="selectMember">
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="couponNum" id="couponNum" value="" disabled="disabled" class="layui-input"/>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <button class="layui-btn layui-btn-primary" id="selectSmember" style="margin-left: 180px;margin-top: 10px;" type="button">选择用户</button>
                <button class="layui-btn layui-btn-primary" id="selectExcel" style="margin-left: 180px;margin-top: 10px;" type="button" disabled >选择文件</button>
            </div>
        </div>
