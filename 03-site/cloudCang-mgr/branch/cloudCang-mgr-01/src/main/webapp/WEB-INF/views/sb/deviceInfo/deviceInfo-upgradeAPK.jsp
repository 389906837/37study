        ...
        <div class="ibox-content m-t">
            ...
            <div class="layui-form-item">
                <div class="layui-col-md6" id="ftpUp" name="ftpUp">
                    <button type="button" class="layui-btn" id="apkButton">选择上传Apk文件</button>
                </div>
                <div class="layui-col-md6"id="localUp" name="localUp" style="display:none;" >
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="localAddress" id="localAddress"
                               value="" placeholder="请填写服务器本地文件路径！"
                               class="layui-input"/>
                    </div>
                </div>
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="version" id="version" placeholder="仅支持整数..." datatype="n1-10"
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layedit', 'upload', 'laydate'], function () {
        ...
        form.on('select(upFileType)', function (data) {
            if (10 == data.value) {
                $("#ftpUp").css("display", "block");
                $("#localUp").css("display", "none");
                $("#localAddress").val("");
            } else {
                $("#ftpUp").css("display", "none");
