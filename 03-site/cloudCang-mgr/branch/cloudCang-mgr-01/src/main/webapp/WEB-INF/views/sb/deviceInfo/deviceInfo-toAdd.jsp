                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-col-md6">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="sname" placeholder="必填..." datatype="*" nullmsg="请输入设备名称" id="sname"
                                           class="layui-input"/>
                                </div>
                            </div>
                            <div class="layui-col-md6">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-col-md6">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="sreaderSerialNumber" id="sreaderSerialNumber" placeholder="必填..." datatype="*" nullmsg="请输入读写器序列号" class="layui-input"/>
                                </div>
                            </div>
                            <div class="layui-col-md6">
                                <label class="layui-form-label">设备型号</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="sdeviceModel" id="sdeviceModel" placeholder="必填..." datatype="*" nullmsg="请输入设备型号" class="layui-input"/>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-col-md6">
                                ...
                                <div class="layui-input-inline">
                                    ...
                                    <cang:select type="dic" name="icooperationMode" id="icooperationMode" entire="true"
                                                 layFilter="icooperationMode"  exp="datatype=\"*\" nullmsg=\"请选择合作模式\"" value="" groupNo="SP000104"/>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-col-md6">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="ilayerNum" id="ilayerNum" value="" placeholder="默认值:5" class="layui-input"/>
                                </div>
                            </div>
                        </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-col-md6" style="display: none;" id="com_elec_Float">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="ielectronicFloat" id="ielectronicFloat" value="" nullmsg="请输入带1-2位小数的正数" datatype="/^[0-9]+(\.[0-9]{1,2})?$/" ignore="ignore" placeholder="默认值：0.00" class="layui-input"  />
                                    </div>
                                </div>
                            </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-col-md6">
                                ...
                                <div class="layui-input-inline">
                                    <textarea class="layui-textarea" name="sremark" id="sremark" value="" style="width: 720px;height: 100px"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-md6">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="spcbModel" id="spcbModel" value=""
                                       class="layui-input"/>
                            </div>
                        </div>
                    </div>
