    ...
    <form class="layui-form" action="${ctx}/merchantClientConf/update" method="post" id="myForm"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-inline">
                    <input type="text" name="scustomerServiceTime" datatype="*" nullmsg="请输入客服服务时间" id="scustomerServiceTime"
                           value="${merchantClientConf.scustomerServiceTime}" class="layui-input"/>
                </div>
            </div>
        </div>
    <%-- <div class="layui-form-item">
             <label class="layui-form-label" style="width: 150px;margin-bottom: 15px">模板风格</label>
             <div class="layui-block">
                 <input type="radio" name="sex" value="0" title="默认" checked <c:if
                         test="${merchantClientConf.scolor eq 10}"> </c:if>>
                 <input type="radio" name="sex" value="1" title="简约" <c:if
                         test="${merchantClientConf.scolor eq 20}"> </c:if>>
             </div>
         </div>--%>
        <div class="layui-form-item">
            <div class="layui-col-md6">
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-inline">
                    <input type="text" name="scloudAppId" datatype="*" nullmsg="请输入云端识别AppId" id="scloudAppId"
        ...
        <div class="layui-form-item ">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    ...
                    <%--entire="true" entireName="请选择是否开启实时盘货"--%>
                </div>
            </div>
        </div>
