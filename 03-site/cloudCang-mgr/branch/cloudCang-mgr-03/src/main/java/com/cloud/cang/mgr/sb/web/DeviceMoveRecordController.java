...
public class DeviceMoveRecordController extends GenericController {
    ...
    ResponseVo<DeviceMoveRecord> save(DeviceMoveRecord deviceMoveRecord) {
        ...
        if (StringUtils.isBlank(deviceMoveRecord.getId())) {
            ...
            // 操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.add.device.moverecord")+ MessageSourceUtils.getMessageByKey("main.code",null)+"{1}", deviceMoveRecord.getSdeviceCode());
    ...
    ResponseVo<String> delete(String[] checkboxId) {
        try {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.delete.devicmove.fail"));
        }
    }
    ...
    ResponseVo<DeviceMoveRecord> deviceMove(DeviceMoveRecord deviceMoveRecord) {
        ...
        try {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo(MessageSourceUtils.getMessageByKey("sb.update.devicmove.fail"));
        }
    }
    ...
    ResponseVo<DeviceMoveRecord> deviceComplete(DeviceMoveRecord deviceMoveRecord) {
        try {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.update.devicmove.status.fail"));
        }
    }
    ...
    ResponseVo<String> deviceClose(String checkboxId, Integer type) {
        try {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.update.devicmove.cancel.status.fail"));
        }
    }
}
