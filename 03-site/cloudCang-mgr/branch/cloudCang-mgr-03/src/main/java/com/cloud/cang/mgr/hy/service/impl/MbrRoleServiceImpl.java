	...
	public void delete(String[] checkboxId) {
		for (String id:checkboxId)
		{
			...
			if (mbrRole != null)
			{
				...
				//操作日志
				String logText= MessageFormat.format(MessageSourceUtils.getMessageByKey("log.hy.delete.role")+ MessageSourceUtils.getMessageByKey("main.name",null)+"{0}",mbrRole.getSroleName() );
