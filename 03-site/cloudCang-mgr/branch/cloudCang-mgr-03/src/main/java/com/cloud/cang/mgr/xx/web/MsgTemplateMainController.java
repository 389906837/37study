...
public class MsgTemplateMainController {
    ...
    public @ResponseBody ResponseVo<MsgTemplateMain> save(MsgTemplateMain msgTemplateMain){
        ...
        if (exist != null){
            return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("xx.save.msg.templatemain.exist"));
        }
        // 如果ID为空就添加
        if (StringUtils.isBlank(msgTemplateMain.getId())){
            ...
            // 操作日志
            String logText= MessageFormat.format(MessageSourceUtils.getMessageByKey("xxcon.add.template.category.name",null)+"{0},"+ MessageSourceUtils.getMessageByKey("main.code",null)+"{1}",msgTemplateMain.getSmsgName(),msgTemplateMain.getScode() );
...
//            msgTemplateMain.setSmerchantCode(oldMsgTemplateMain.getSmerchantCode());
            ...
            msgTemplateMain.setIdelFlag(0);
            // 操作日志
            String logText=MessageFormat.format( MessageSourceUtils.getMessageByKey("xxcon.modify.template.category.name",null)+"{0},"+MessageSourceUtils.getMessageByKey("main.code",null)+"{1}",msgTemplateMain.getSmsgName(),msgTemplateMain.getScode() );
    ...
    public @ResponseBody ResponseVo<String> delete (String [] checkboxId){
        ...
        return ResponseVo.getSuccessResponse();
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("xxcon.template.delete.excetion",null));
        }
    }
}
