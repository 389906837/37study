...
public class CommoditySkuController extends GenericController {
    ...
    public ResponseVo<String> batchImpVrComInfo(@RequestParam(value = "file", required = true) MultipartFile file) {
        ...
        try {
            ...
            if (responseVo.isSuccess()) {
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.batch.import.visual.products",null)+","+MessageSourceUtils.getMessageByKey("main.visual.product.number",null)+"{0}", responseVo.getData());
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.bulk.uploading.visual.product.error",null));
    }
    ...
    public ResponseVo<String> skuAdd(@RequestParam(value = "file", required = false) MultipartFile skuImgfile, CommoditySku commoditySku) {
        ...
        try {
            ...
            if (StringUtils.isBlank(commodityName)) {
                return new ResponseVo<>(false, ErrorCodeEnum.ERROR_COMMON_SYSTEM.getCode(), MessageSourceUtils.getMessageByKey("vrcon.product.name.empty",null));
            }
            if (StringUtils.isBlank(svrCode)) {
                return new ResponseVo<>(false, ErrorCodeEnum.ERROR_COMMON_SYSTEM.getCode(), MessageSourceUtils.getMessageByKey("vrcon.visual.product.number.empty",null));
            }
            ...
            if (CollectionUtils.isNotEmpty(vrCommodityList)) {
                return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.visual.product.number.exists",null));
            }

            //插入数据到商品信息表
            ResponseVo<String> responseVo = commoditySkuService.insertCommoditySku(commoditySku, skuImgfile);
            //操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.add.visual.goods",null)+"，"+ MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", commoditySku.getScode());
            LogUtil.addOPLog(LogUtil.AC_ADD, logText, null);
        ...
        return new ResponseVo<>(false, 111, MessageSourceUtils.getMessageByKey("vrcon.add.visual.goods.error",null));
    }
    ...
    public @ResponseBody ResponseVo<String> skuDelete(String[] checkboxId) {
        ...
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.delete.visual.goods",null), "");
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.delete.visual.goods.error",null));
    }
        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != commoditySku) {
                    ...
                    map.put("commoditySku", commoditySku);
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.modify.visual.goods",null)+"，"+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", commoditySku.getScode());
    ...
    public @ResponseBody ResponseVo<String> vrCommodityToEdit(@RequestParam(value = "file", required = false) MultipartFile scommodityImgfile,CommoditySku commoditySku) {
        ...
        if (StringUtils.isBlank(svrCode)) {
            return new ResponseVo<>(false, ErrorCodeEnum.ERROR_COMMON_PARAM.getCode(), MessageSourceUtils.getMessageByKey("vrcon.visual.product.number.empty",null));
        }
        if (StringUtils.isBlank(sid)) {
            return new ResponseVo<>(false, ErrorCodeEnum.ERROR_COMMON_PARAM.getCode(), MessageSourceUtils.getMessageByKey("vrcon.modify.visual.goods.error",null));
        }
        try {
            ...
            String logText1 = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.edit.visual.goods",null)+"，"+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", commoditySku1.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.edit.visual.goods.error",null));
    }
        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != commoditySku) {
                    ...
                    map.put("commoditySku", commoditySku);
                    String logText4 = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.view.visual.goods",null)+"，"+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", commoditySku.getScode());
    ...
    public @ResponseBody ResponseVo<String> skuDisable(String[] checkboxId) {
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                if (StringUtils.isNotBlank(id)) {
                    ...
                    if (null != commoditySku) {
                        String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.disable.visual.goods",null)+"{0}", commoditySku.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.disable.visual.goods.error",null));
    }
    ...
    public @ResponseBody ResponseVo<String> skuEnable(String[] checkboxId) {
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                if (StringUtils.isNotBlank(id)) {
                    CommoditySku commoditySku = commoditySkuService.selectByPrimaryKey(id);
                    if (null != commoditySku) {
                        String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.enable.visual.goods",null)+","+MessageSourceUtils.getMessageByKey("main.visual.product.number",null)+"{0}", commoditySku.getScode());
                        LogUtil.addOPLog(LogUtil.AC_EDIT, logText, null);
                    }
                }
                return responseVo;
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.enable.visual.goods.error",null));
    }
    ...
    public @ResponseBody ResponseVo<String> skuDropoff(String[] checkboxId) {
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                if (StringUtils.isNotBlank(id)) {
                    CommoditySku commoditySku = commoditySkuService.selectByPrimaryKey(id);
                    String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.under.visual.goods",null)+"{0}", commoditySku.getScode());
                    LogUtil.addOPLog(LogUtil.AC_EDIT, logText, null);
                }
                return responseVo;
            }
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.under.visual.goods.error",null));
    }
    ...
    public @ResponseBody ResponseVo<String> skuShelf(String[] checkboxId) {
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.shelf.visual.goods",null)+"{0}", responseVo.getData());
                LogUtil.addOPLog(LogUtil.AC_EDIT, logText, null);
                return responseVo;
            }
        } catch (Exception e) {
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.shelf.visual.goods.error",null));
    }
    ...
    public @ResponseBody ResponseVo<String> toSynchronize(String[] checkboxId) {
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.sync.visual.goods",null)+","+MessageSourceUtils.getMessageByKey("main.visual.product.number",null)+"{0}", responseVo.getData());
                LogUtil.addOPLog(LogUtil.AC_VIEW, logText, null);
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.sync.visual.goods.error",null));
    }
    /* ----------0.视觉识别商品标准SKU表结束 ----------*/
    ...
    ResponseVo<String> addToMerchantSKU(String vrCommodityIds, String merchantId) {
        try {
            if (StringUtils.isBlank(merchantId)) {
                return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.add.merchant.visual.goods.error",null));
            }
            //商户和视觉商品SKU关系表
            ResponseVo<String> responseVo = merchantSkuService.insertVrCommodityIds(vrCommodityIds, merchantId);
            //操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("vrcon.add.merchant.visual.goods",null)+"{0}", responseVo.getData());
            LogUtil.addOPLog(LogUtil.AC_ADD, logText, null);
            return responseVo;
        } catch (ServiceException e) {
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("vrcon.add.merchant.visual.goods.exception",null));
    }
    /* ----------1.商户SKU库结束 ----------*/
