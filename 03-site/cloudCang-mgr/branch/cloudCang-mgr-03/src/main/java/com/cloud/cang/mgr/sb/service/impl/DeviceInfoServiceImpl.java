...
public class DeviceInfoServiceImpl extends GenericServiceImpl<DeviceInfo, String> implements
    ...
    public ResponseVo<String> invokeDeviceOperating(DeviceOperatingDto deviceOperatingDto, String method) {
        ResponseVo<String> responseVo = ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.remote.send.error"));
    ...
    public ResponseVo<DeviceInfo> insertDeviceInfo(DeviceInfo deviceInfo, DeviceManage deviceManage, DeviceModel deviceModel, MonitorDataConf monitorDataConf, HttpServletRequest request, String readerID, String merchantId) {
        ...
        if (StringUtils.isNotEmpty(deviceCode) && StringUtils.isNotBlank(merchantCode)) {
            ...
            if (null == isupportAi) {
                return ErrorCodeEnum.ERROR_APP_PARAM_EXCEPTION.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.save.ai.required"));
            }
            ...
            //操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.add.device.code")+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", deviceInfo.getScode());
...
//                }
    ...
    public ResponseVo<DeviceInfo> updateInfo(DeviceInfo oldDevice, DeviceInfo deviceInfo, DeviceManage deviceManage, DeviceModel deviceModel, MonitorDataConf monitorDataConf, HttpServletRequest request) throws Exception {
        ...
        if (null == deviceInfoBean) {
            return ErrorCodeEnum.ERROR_APP_PARAM_EXCEPTION.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.not.exist"));
        }
        ...
        if ((null == oldIsSupportAi && 1 == newIsSupportAi) || (null != oldIsSupportAi && 0 == oldIsSupportAi && 1 == newIsSupportAi)) { // 以前不支持，现在支持
            ...
            if (StringUtils.isNotBlank(oldAiCode) && StringUtils.isNotBlank(oldAiId)) {
                ...
                if (StringUtils.isBlank(aiCode)) {
                    ...
                    return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.update.error"));
                }
                AiInfo aiInfo = new AiInfo();
                aiInfo.setSaiCode(aiCode);
            ...
            if (null != aiInfoStatus && 20 == aiInfoStatus.getIstatus() && 10 == aiInfoStatus.getIoperType()) {
                ...
                return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.unable.update.error"));
            }
        ...
        BigDecimal ielectronicFloat = deviceInfo.getIelectronicFloat();
        if (null == isupportWeigh) {
            return ErrorCodeEnum.ERROR_APP_PARAM_EXCEPTION.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.save.weighing.required"));
        }
        if (isupportWeigh == 1) {
            if (null == ielectronicFloat) {
                deviceInfo.setIelectronicFloat(new BigDecimal(0.00));
        ...
        deviceInfoDao.updateByIdSelective(deviceInfo);
        //操作日志
        String logText1 = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.update.device.info")+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", deviceInfo.getScode());
        ...
        if (StringUtils.isNotBlank(deviceManageId)) {
            ...
            String logText2 = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.update.device.manager.info")+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", deviceInfo.getScode());
        ...
        if (StringUtils.isNotBlank(deviceModelId)) {
            ...
            String logText3 = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.update.device.detail.info")+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", deviceInfo.getScode());
...
//            monitorDataConfDao.updateByIdSelective(monitorDataConf);
            ...
            String logText4 = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.update.device.config.info")+ MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", deviceInfo.getScode());
...
//        }
    ...
    public ResponseVo<String> updateDeviceStatus(String[] checkboxId) {
        ...
        for (String id : checkboxId) {
            ...
            if (null != deviceInfo && !Integer.valueOf(20).equals(deviceInfo.getIstatus())) { // 正常设备才能进行离线操作
                return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.update.status.error"));
            }
        }
    ...
    public ResponseVo<String> updateDeviceOperatingStatus(String[] checkboxId, String status) {
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("common.operation.error"));
    }
    ...
    public ResponseVo<DeviceInfo> updateInfo(DeviceInfo deviceInfo, DeviceManage deviceManage, HttpServletRequest request) {
        ...
        if (StringUtils.isBlank(deviceInfo.getSname())) {
            return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.update.name.not.empty"));
        }
        if (StringUtils.isNotBlank(deviceId)) {
    ...
    public ResponseVo<String> checkDeviceAttribution(String[] array, String merchantId) {
        ...
        if (CollectionUtils.isNotEmpty(deviceInfoList)) {
            ...
            return ResponseVo.getSuccessResponse(MessageSourceUtils.getMessageByKey("sb.check.device.pass"));
        }
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.check.error"));
    }
    ...
    public ResponseVo<String> inventory(String deviceId) {
        ...
        DeviceInfo deviceInfo = deviceInfoDao.selectByPrimaryKey(deviceId);
        if (null == deviceInfo) {
            return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.status.error"));
        }
        if (deviceInfo.getIstatus() != 20) {
            return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.not.online"));
        }
    ...
    public ResponseVo upgradeVoice(MultipartFile file, String voiceType, String deviceIds, String
        ...
        if (StringUtils.isNotBlank(url)) {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("upload.voice.file.fail"));
        }
    }
    ...
    public ResponseVo<String> adjustVolume(String volumeValue, String deviceIds, String irangeDevice,
        ...
        if (responseVo.isSuccess()) {
            insertBackstageOperLog(10, irangeDevice, MessageSourceUtils.getMessageByKey("sb.adjust.the.volume")+"：" + volumeValue, deviceOperatingDto, user);
        }
        return responseVo;
    }
    ...
    public ResponseVo<String> reboot(String deviceIds, String irangeDevice, String merchantId, String user, String deviceCodes, String merchantCode) {
        ...
        if (responseVo.isSuccess()) {
            insertBackstageOperLog(20, irangeDevice, MessageSourceUtils.getMessageByKey("sb.reboot.device"), deviceOperatingDto, user);
        }
        return responseVo;
    }
    ...
    public ResponseVo<String> shutdown(String deviceIds, String deviceCodes, String irangeDevice, String merchantId, String merchantCode, String user) {
        ...
        if (responseVo.isSuccess()) {
            insertBackstageOperLog(30, irangeDevice, MessageSourceUtils.getMessageByKey("sb.shutdown"), deviceOperatingDto, user);
        }
        return responseVo;
    }
    ...
    public ResponseVo<String> batchRealTimeShoppingCartSwitch(String merchantId, String merchantCode, String shoppingInventory, String replenishmentInventory, String deviceIds, String deviceCodes, String deviceType) {
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.batch.update.shopping.car.fail"));
    }
    ...
    public ResponseVo<List<DeviceInventoryStockDomain>> getDeviceStock(String deviceId) {
        ...
        if (StringUtils.isBlank(goodsString)) {
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.not.find.device.stock"));
        }
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.get.device.stock.error"));
    }
    ...
    public ResponseVo<String> saveActiveInventoryStockInfo(String deviceId, String commodityIds, HttpServletRequest request) {
        DeviceInfo deviceInfo = deviceInfoDao.selectByPrimaryKey(deviceId);
        if (null == deviceInfo) {
            return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.not.exist"));
        }
