...
public class DeviceMalfunctionRecordController extends GenericController {
    ...
    ResponseVo<DeviceMalfunctionRecord> save(DeviceMalfunctionRecord deviceMalfunctionRecord) {
        ...
        if (StringUtils.isBlank(deviceMalfunctionRecord.getId())) {
            ...
            // 操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.add.device.malfunction")+ MessageSourceUtils.getMessageByKey("main.code",null)+"{1}", deviceMalfunctionRecord.getSdeviceCode());
            ...
            // 操作日志
            String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("log.update.device.malfunction")+MessageSourceUtils.getMessageByKey("main.code",null)+"{1}", deviceMalfunctionRecord.getSdeviceCode());
    ...
    ResponseVo<String> delete(String[] checkboxId) {
        try {
            ...
            //"删除设备故障信息！"
            return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("sb.delete.error"));
        }
    }
    ...
    ResponseVo<DeviceMalfunctionRecord> deviceFailure(DeviceMalfunctionRecord deviceMalfunctionRecord) {
        try {
            ...
            return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo(MessageSourceUtils.getMessageByKey("sb.device.manually.modifying.failure"));
        }
    }
}
