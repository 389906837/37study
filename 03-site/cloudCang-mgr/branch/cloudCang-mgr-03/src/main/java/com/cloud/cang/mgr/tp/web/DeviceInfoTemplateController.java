...
public class DeviceInfoTemplateController extends GenericController {
    ...
    public ResponseVo<DeviceInfoTemplate> commodityAdd(DeviceInfoTemplate deviceInfoTemplate) {
        try {
            ...
            if (null == deviceInfoTemplate.getIsupportWeigh() || 0 == deviceInfoTemplate.getIsupportWeigh()) {
                deviceInfoTemplate.setIweightType(null);
            }
            ...
            if (BooleanUtils.isTrue(responseVo.isSuccess())) {
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("tpcon.add.device.template",null)+"，"+MessageSourceUtils.getMessageByKey("main.name",null)+"{0}", sname);
        ...
        return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo(MessageSourceUtils.getMessageByKey("tpcon.add.device.template.error",null));
    }
    ...
    public ResponseVo<String> delete(String[] checkboxId) {
        ...
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format(MessageSourceUtils.getMessageByKey("tpcon.delete.device.template",null), "");
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo(MessageSourceUtils.getMessageByKey("tpcon.delete.device.template.error",null));
    }
        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != deviceInfoTemplate) {
                    map.put("deviceInfoTemplate", deviceInfoTemplate);
                    String logText4 = MessageFormat.format(MessageSourceUtils.getMessageByKey("tpcon.edit.device.details.template",null)+"{0}", deviceInfoTemplate.getScode());
    ...
    public ResponseVo<DeviceInfoTemplate> edit(DeviceInfoTemplate deviceInfoTemplate) {
        ...
        if (StringUtils.isBlank(sid) && StringUtils.isBlank(sname)) {
            return ErrorCodeEnum.ERROR_COMMON_SAVE.getResponseVo(MessageSourceUtils.getMessageByKey("tpcon.device.details.template.name.empty",null));
        }
        try {
            if (null == deviceInfoTemplate.getIsupportWeigh() || 0 == deviceInfoTemplate.getIsupportWeigh()) {
                deviceInfoTemplate.setIweightType(null);
            ...
            //操作日志
            String logText1 = MessageFormat.format(MessageSourceUtils.getMessageByKey("tpcon.modify.device.template",null)+"，"+ MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", deviceInfoTemplate.getScode());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("tpcon.modify.device.template.error",null));
    }
    ...
    public String View(String sid, ModelMap map) {
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != deviceInfoTemplate) {
                    map.put("deviceInfoTemplate", deviceInfoTemplate);
                    String logText4 = MessageFormat.format(MessageSourceUtils.getMessageByKey("tpcon.view.device.template",null)+"，"+MessageSourceUtils.getMessageByKey("main.name",null)+"{0}", deviceInfoTemplate.getScode());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText4, null);
    ...
    public ResponseVo<String> changeStatus(String[] checkboxId) {
        ...
        try {
            ...
            //操作日志
            String logText1 = MessageFormat.format(MessageSourceUtils.getMessageByKey("tpcon.modify.device.template.status",null)+"，"+MessageSourceUtils.getMessageByKey("main.code",null)+"{0}", responseVo.getData());
            LogUtil.addOPLog(LogUtil.AC_EDIT, logText1, null);
            return responseVo;
        } catch (ServiceException e) {
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo(MessageSourceUtils.getMessageByKey("tpcon.modify.device.template.status.error",null));
    }
