    ...
    <div class="layui-form-item wflayui-form-item">
        <table  cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td class="text-right" style="width:32%">
                    <c:if test="${deviceModel.scontrastMode eq 'rawstock' }">原始库存</c:if>
                    <c:if test="${deviceModel.scontrastMode  eq  'openDoor' }">开关门盘货</c:if>
                </td>
                <td class="text-left" style="width:18%">whether to support layered goods：</td>
                <td class="text-right" style="width:32%">
                    <c:if test="${deviceModel.isupportSingleLayer == 0 }">Fasle</c:if>
                    <c:if test="${deviceModel.isupportSingleLayer == 1 }">True</c:if>
                </td>
            </tr>
        </table>
    </div>
