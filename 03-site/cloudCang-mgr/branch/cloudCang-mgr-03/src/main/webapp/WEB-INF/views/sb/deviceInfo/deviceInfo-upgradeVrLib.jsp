        ...
        <div class="ibox-content m-t">
            ...
            <div class="layui-form-item">
                <div id="uploader" class="wu-example">
                    <!--用来存放文件信息-->
                    <div class="btns">
                        <div id="picker">Upload visual identity library upgrade package file</div>
                        <span class="require" style="color:red">(Please select the zip file to upload and save it after saving.!)</span>
                        <div id="thelist" class="uploader-list"></div>
                    </div>
                </div>
                <div class="layui-col-md6" id="localUp" name="localUp" style="display:none;">
                    <label class="layui-form-label">upgrade package address</label>
                    <div class="layui-input-inline">
                        <input type="text" name="url" id="url"
                               value="" placeholder="please enter the upgrade address"
                               class="layui-input"/>
                    </div>
                </div>
                <div class="layui-col-md6">
