...
<body class="gray-bg">
<form class="layui-form" action="${ctx}/annualMeetingFaceInfo/batchImportFaceInfo" method="post" id="myForm" enctype="multipart/form-data">
    <div class="col-sm-12">
        <div class="ibox-content m-t">
            ...
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    ...
                    <div class="layui-input-inline">
                        <a href="${staticSource}/resources/images/am07.xlsx" download="<spring:message code='fr.batch.import.templates' />Excel07"><spring:message code='fr.batch.import.template.excel2007.download' /></a>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"></label>
                    <div class="layui-input-inline">
                        <a href="${staticSource}/resources/images/am03.xls" download="<spring:message code='fr.batch.import.templates' />Excel03"><spring:message code='fr.batch.import.template.excel2003.download' /></a>
                    </div>
                </div>
            </div>
        </div>
