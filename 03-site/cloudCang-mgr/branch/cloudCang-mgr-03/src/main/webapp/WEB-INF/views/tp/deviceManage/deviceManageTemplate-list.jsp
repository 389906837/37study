        ...
        <div class="col-sm-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><spring:message code="tpmanage.device.management.information.template.management" /></h5>
                </div>
                <div class="ibox-content">
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            <div class="layui-input-inline">
                                <input type="text" name="scode" id="scode" value="" placeholder='<spring:message code="tpmanage.template.number" />...'
                                       class="layui-input">
                            </div>
                            <div class="layui-input-inline">
                                <input type="text" name="sname" id="sname" value=""
                                       placeholder='<spring:message code="tpmanage.template.name" />...' class="layui-input">
                            </div>
                            <div class="layui-input-inline">
...
<script type="text/javascript">
    var colModel = [
        ...
        {name: 'scode', index: 'SCODE', label: "<spring:message code='tpinfotoadd.template.number' />",width:320},
        {name: 'sname', index: 'SNAME', label: "<spring:message code='tpinfotoadd.template.name' />",width:320},
        {
            name: 'istatus',
            index: 'ISTATUS',
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (data[i].istatus == 10) {
                    ...
                    str += "<img src='${staticSource}/resources/images/oper_icon/disable.png' class=\"oper_icon\" onclick=\"disableMethod('"
                        + cl + "')\" title='<spring:message code='sh.discontinue.use' />' alt='<spring:message code='sh.discontinue.use' />'  /> | ";
                    </shiro:hasPermission>
    ...
    function viewMethod(sid) {
        showLayerMedium('<spring:message code="tpmanage.template.details" />', ctx + '/deviceManageTemplate/view?sid=' + sid);
    }
    function editMethod(sid) {
        showLayerMedium('<spring:message code="tpmanage.edit.template.information" />', ctx + '/deviceManageTemplate/toEdit?sid=' + sid);
    }
    function delMethod(sid) {
        confirmDelTip('<spring:message code="tpmanage.make.sure.you.want.to.delete.data" />?', ctx + "/deviceManageTemplate/delete", {checkboxId: sid});
    }
    function disableMethod(sid) {
        confirmOperTip('<spring:message code="tpmanage.make.sure.you.want.to.deactivate.the.template" />?', ctx + "/deviceManageTemplate/changeStatus", {checkboxId: sid});
    }
    function enableMethod(sid) {
        confirmOperTip('<spring:message code="tpmanage.make.sure.you.want.to.enable.the.template" />?', ctx + "/deviceManageTemplate/changeStatus", {checkboxId: sid});
    }
</script>
</body>
</html>
