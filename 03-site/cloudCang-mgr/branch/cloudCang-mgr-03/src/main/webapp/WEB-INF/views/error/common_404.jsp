...
<head>
    ...
    <title><spring:message code='error.the.page.is.gone' /></title>
...
<div class="main">
    <div>
        ...
        <p class="p1"><spring:message code='error.sorry.the.page.address.you.visited.is.incorrect' /></p>
        <p class="p2"><spring:message code='error.please.check.that.the.url.you.entered.is.correct' /></p>
    </div>
