    ...
    <form class="layui-form" action="${ctx}/device/deviceMove" method="post" id="myForm">
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <select id="istatus" name="istatus" datatype="*" nullmsg="<spring:message code='sb.please.select.the.audit.status' />">
                        <option value=""><spring:message code='sb.please.select.the.audit.status' /></option>
                        <option value="20" <c:if test="${20 == deviceMoveRecord.istatus}">selected</c:if>><spring:message code="main.approval" /></option>
                        <option value="30" <c:if test="${30 == deviceMoveRecord.istatus}">selected</c:if>><spring:message code="main.rejection" /></option>
                    </select>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <textarea class="layui-textarea" id="tauditOpinion" name="tauditOpinion" datatype="*" nullmsg="<spring:message code='sb.please.fill.in.the.review.comments' />" style="width: 500px">${deviceMoveRecord.tauditOpinion}</textarea>
                </div>
            </div>
        </div>
