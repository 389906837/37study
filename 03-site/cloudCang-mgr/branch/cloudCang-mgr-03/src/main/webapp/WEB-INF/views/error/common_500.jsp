...
<head>
    ...
    <title><spring:message code='error.system.error' /></title>
...
<div class="main">
    <div>
        <img src="${staticSource}/resources/images/500.png">
        <p class="p1"><spring:message code='error.sorry' /></p>
        <p class="p2"><spring:message code='error.the.server.encountered.an.error.and.could.not.access.the.page' /></p>
    </div>
