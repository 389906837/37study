...
<div class="ibox-content">
    <form class="layui-form" action="${ctx}/orderRecord/save" method="post" id="myForm" onsubmit="return false;">
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.total.amount.yuan' /></label>
                <div class="layui-input-inline">
            ...
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.total.amount.of.the.offer.yuan' /></label>
                <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.first.order.discount.amount.yuan' /></label>
                <div class="layui-input-inline">
            ...
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.promotional.discount.amount.yuan' /></label>
                <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.coupon.deduction.amount.yuan' /></label>
                <div class="layui-input-inline">
            ...
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.total.amount.paid.yuan' /></label>
                <div class="layui-input-inline">
        ...
        <div class="wfsplitt">
            <spring:message code='om.order.details' />
        </div>
        <div class="layui-input-block mt15">
            <div class="clearfix layui-input-title"><input class="choose-btn" type="button" onclick="selectCommodity();"
                                                           value="<spring:message code='sb.select.product' />"/></div>
                    ...
                    <div class="layui-card-body">
                        <table class="layui-table layuiadmin-page-table ">
                            ...
                            <tr>
                                ...
                                <th><spring:message code='om.commodity.sales.price.yuan' /></th>
                                <th><spring:message code='sb.number.of.products' /></th>
                                <th><spring:message code='om.total.commodities.yuan' /></th>
                                <th style="width: 100px;"><spring:message code='om.total.amount.of.the.offer.yuan' /></th>
                                <th style="width: 100px;"><spring:message code='om.first.order.discount.amount.yuan' /></th>
                                <th style="width: 100px;"><spring:message code='om.promotional.discount.amount.yuan' /></th>
                                <th style="width: 100px;"><spring:message code='om.voucher.deduction.amount.yuan' /></th>
                                <th style="width: 100px;"><spring:message code='om.actual.payment.amount.yuan' /></th>
...
<script type="text/javascript">
    ...
    function selectCommodity() {
        var commodityIds = $("#commodityIds").val();
        if (!isEmpty(commodityIds)) {
            showLayer("<spring:message code='sb.select.product' />", ctx + "/common/selectCommodityByMap?commodityIds=" + commodityIds + "&deviceId=${orderRecord.sdeviceId}", {area: ['90%', '80%']});
        } else {
            showLayer("<spring:message code='sb.select.product' />", ctx + "/common/selectCommodityByMap?deviceId=${orderRecord.sdeviceId}", {area: ['90%', '80%']});
        }
    }
