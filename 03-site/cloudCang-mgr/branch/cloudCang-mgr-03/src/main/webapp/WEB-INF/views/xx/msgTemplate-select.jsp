                ...
                <form class="layui-form" action="${ctx}/msgTemplate/bat" method="post" id="myForm">
                    <div class="layui-form-item fixed-bottom">
                        <div class="layui-input-block">
                            ...
                            <button class="layui-btn" type="button" id="myFormSub"><spring:message code="main.confirm" /></button>
                        </div>
                    </div>
...
//                {name: 'sextInfo',index: 'sextInfo',label : "<spring:message code='xx.vendor.extension.information' />",sortable : false,width:100},
//                {name: 'sdesc',index: 'sdesc',label : "<spring:message code='xx.supplier.description' />",sortable : false,width:100},
            ],
            <c:if test="${isBatchUpdate ne 1}">
            // 双击添加
