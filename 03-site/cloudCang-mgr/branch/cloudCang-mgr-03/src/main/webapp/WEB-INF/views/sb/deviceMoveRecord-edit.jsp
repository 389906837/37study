...
<body>
    <div class="ibox-content">
        <form class="layui-form" action="${ctx}/device/save" method="post" id="myForm">
            <input type="hidden" id="sdeviceId" name="sdeviceId" value="${deviceMoveRecord.sdeviceId}"/><%--<spring:message code='main.device' />ID--%>
            <input type="hidden" id="sdeviceCode" name="sdeviceCode" value="${deviceMoveRecord.sdeviceCode}"/><%--<spring:message code='main.device.id' />--%>
            ...
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"><spring:message code='sb.delivery.detailed.address' /></label>
                    <div class="layui-input-inline">
                        <textarea class="layui-textarea" name="sputAddress" placeholder='<spring:message code="main.required" />...' datatype="*" nullmsg="<spring:message code='sb.please.enter.the.address' />" id="sputAddress" value="" style="width: 750px;height: 100px">${deviceInfo.sputAddress}</textarea>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"><spring:message code='sb.planned.relocation.date' /></label>
                    <div class="layui-input-inline">
                        <input type="text" name="tplanMoveTime" datatype="*" nullmsg="<spring:message code='sb.please.select.the.planned.relocation.date' />" id="tplanMoveTime"
            ...
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"><spring:message code='sb.reason.for.relocation' /></label>
                    <div class="layui-input-inline">
