    ...
    <form class="layui-form" action="${ctx}/deviceMal/deviceFailure" method="post" id="myForm">
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='om.processing.time' /></label>
                <div class="layui-input-inline">
                    <input type="text" name="sdealwithTime" datatype="*" nullmsg="<spring:message code='sb.please.select.the.declaration.time' />" id="sdealwithTime"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='main.handler' /></label>
                <div class="layui-input-inline">
                    <input type="text" name="sdealwithMan" id="sdealwithMan"
                           value="${deviceMalfunctionRecord.sdealwithMan}" datatype="*" errormsg="<spring:message code='sb.please.fill.in.the.handler' />"
                           class="layui-input"/>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code='main.processing.notes' /></label>
                <div class="layui-input-inline">
