...
<title><spring:message code="rm.dynamic.replenishment.order" /></title>
    ...
    <div id="printBody">
        <div class="layui-form-item">
            <div class="layui-col-md6">
                <label class="layui-form-label layui-form-label100p" style="text-align: left;padding-left: 0px;"><spring:message code="rm.document.number" />：${replenishment.sreplenishmentCode}</label></div>
            <div class="layui-col-md6">
        ...
        <div class="layui-form-item">
            <table class="layui-table">
                ...
                <tr style="height: 40px;line-height: 40px;">
                    <td><spring:message code="rm.replenisher" />：${replenishment.srenewalName}</td>
