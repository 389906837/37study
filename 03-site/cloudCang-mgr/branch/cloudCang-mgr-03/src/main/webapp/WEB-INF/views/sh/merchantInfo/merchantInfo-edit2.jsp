            ...
            <div class="layui-tab-item">
                <form class="layui-form" action="${ctx}/merchantConf/save" method="post" id="myConfForm">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-md6">
                            <label class="layui-form-label">微信代扣方式</label>
                            <div class="layui-input-inline">
                                <cang:select type="list" name="iwechatWithholdType" id="iwechatWithholdType"
                                             value="${wCmerchantConf.iwechatWithholdType}" list="{10:微信免密代扣,20:微信支付分代扣}"/>
                    </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-col-md6">
                            <label class="layui-form-label">微信服务ID</label>
                            <div class="layui-input-inline">
                                <input type="text" name="sserviceId" value="${wCmerchantConf.sserviceId}"
                                       class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-col-md6">
                            <label class="layui-form-label">微信APIV3私钥地址</label>
                            <div class="layui-input-inline">
                                <input type="text" name="swechatPrivateKeyUrl" value="${wCmerchantConf.swechatPrivateKeyUrl}"
                                       class="layui-input"/>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-col-md6">
                            <label class="layui-form-label">微信APIV3密钥</label>
                            <div class="layui-input-inline">
                                <input type="text" name="swechatApiv3Key"
                                       value="${wCmerchantConf.swechatApiv3Key}"
                                       class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-col-md6">
                            <label class="layui-form-label">微信APIV3证书序列号</label>
                            <div class="layui-input-inline">
                                <input type="text" name="swechatApiv3CertNumber" value="${wCmerchantConf.swechatApiv3CertNumber}"
                                       class="layui-input"/>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-col-md6">
                            <label class="layui-form-label">微信支付分APPID</label>
                            <div class="layui-input-inline">
                                <input type="text" name="swechatPointAppid"
                                       value="${wCmerchantConf.swechatPointAppid}"
                                       class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-col-md6">
                            <label class="layui-form-label">微信支付分MD5秘钥</label>
                            <div class="layui-input-inline">
                                <input type="text" name="swechatPointAppSecret"
                                       value="${wCmerchantConf.swechatPointAppSecret}"
                                       class="layui-input"/>
                            </div>
                        </div>
                    </div>
