    ...
    <form class="layui-form" action="${ctx}/cameraConfig/add"
        ...
        <div class="layui-form-item">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sip" datatype="*" nullmsg="<spring:message code="sb.please.enter"/>IP" id="sip" value="" class="layui-input" />
                </div>
            </div>
            <div class="layui-col-md6">
                <label class="layui-form-label"><spring:message code="sb.the.port.number" /></label>
                <div class="layui-input-inline">
                    <input type="text" name="sport" datatype="*" nullmsg='<spring:message code="sb.please.enter" /><spring:message code="sb.the.port.number" />' id="sport" value="" class="layui-input"/>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item m-t">
            <div class="layui-col-md6">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="sserialNumber" datatype="*" nullmsg='<spring:message code="sb.please.enter" /><spring:message code="sb.serial.number" />' id="sserialNumber" value=""
                           class="layui-input"/>
                </div>
            </div>
            <div class="layui-col-md6">
            ...
            <div class="layui-col-md6">
                ...
                <div class="layui-block">
                    <textarea style="width: 470px" id="sremark" name="sremark"
                              class="layui-textarea layui-form-textarea80p" placeholder='<spring:message code="sb.not.required" />'></textarea>
                </div>
            </div>
        </div>
