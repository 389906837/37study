        ...
        <div class="ibox-content m-t">
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"><spring:message code='sb.adjust.the.volume'/></label>
                    <div class="layui-input-inline">
                    <input type="number" name="volumeValue" class="layui-input" placeholder='<spring:message code="main.required" />...' datatype="*" nullmsg="<spring:message code='sb.please.fill.in.the.volume.value'/>" min="0" max="100" />
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label"><spring:message code="main.operating.equipment.range" /></label>
                    <div class="layui-input-inline">
