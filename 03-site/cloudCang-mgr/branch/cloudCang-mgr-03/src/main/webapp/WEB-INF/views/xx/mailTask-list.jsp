        ...
        <div class="col-sm-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><spring:message code="xx.mailing.record" /></h5>
                </div>
                    ...
                    <div class="layui-form" id="searchForm">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline" style="width: 182px">
                                <input type="text" name="smsgRecipient" id="smsgRecipient" value=""
                                       placeholder='<spring:message code="xx.message.recipient" />...' class="layui-input">
                            </div>
                            <div class="layui-inline" style="width: 182px">
                            ...
                            <div class="layui-inline" style="width: 180px">
                                <input type="text" name="tbeginSendDatetimeStr" id="tbeginSendDatetimeStr"
                                       placeholder='<spring:message code="xx.delivery.time" />' class="layui-input">
                            </div>
                                <div class="layui-inline" style="width: 182px">
                            ...
                            <div class="layui-inline" style="width: 182px">
                                <select class="form-control" name="isenderType" id="isenderType">
                                    <option value=""><spring:message code="xx.send.category" /></option>
...
<script type="text/javascript" src="${staticSource}/resources/page/xx/msgtask/mailTask-list.js"></script>
...
<script type="text/javascript">
    ...
    var colModel = [{name: 'id', index: 'id', hidden: true},
        <c:if test="${SESSION_KEY_ROOT_MERCHANT eq 1}">
        {name: 'SHCODE',label : '<spring:message code="main.merchant.number" />',index: 'SHCODE',width:120},
        ...
        {name: 'SMSG_RECIPIENT', index: 'SMSG_RECIPIENT', label: '<spring:message code="xx.message.recipient" />', sortable: false, width: 150},
        {
            name: 'ISTATE',
            index: 'ISTATE',
            label: '<spring:message code="xx.message.status" />',
            editable: true,
            formatter: "select",
            editoptions: {value: '1:<spring:message code="xx.to.be.sent" />;2:<spring:message code="xx.sending" />;3:<spring:message code="xx.successful.delivery" />;4:<spring:message code="xx.fail.in.send" />;5:<spring:message code="xx.excess.invalid" />'},
            sortable: false,
            width: 90
        },
        {
            name: 'TBEGIN_SEND_DATETIME',
            index: 'TBEGIN_SEND_DATETIME',
            label: '<spring:message code="xx.delivery.time" />',
        ...
        },
        {
            ...
            formatter: "select", editoptions: {value: '0:<spring:message code="xx.no.timeout" />;1:<spring:message code="xx.time.out" />'}, sortable: false, width: 90
        },
        {
        ...
        },
        {
            ...
            formatter: "select", editoptions: {value: '2:<spring:message code="main.no" />;1:<spring:message code="main.yes" />'}, sortable: false, width: 90
        },
        {
            name: 'IIS_REALTIME', index: 'IIS_REALTIME', label: '<spring:message code="xx.sending.policy" />', editable: true,
            formatter: "select", editoptions: {value: '1:<spring:message code="xx.real.time" />;2:<spring:message code="xx.delayed" />'}, sortable: false, width: 90
        },
        {
            name: 'ISENDER_TYPE', index: 'ISENDER_TYPE', label: '<spring:message code="xx.send.category" />', editable: true,
            formatter: "select", editoptions: {value: '1:<spring:message code="xx.single.sending" />;2:<spring:message code="xx.group.sending" />'}, sortable: false, width: 90
        },
        {name: 'SCONTENT', index: 'SCONTENT', label: '<spring:message code="xx.message.content" />', sortable: false, width: 300},
        {name: 'SMSG_CC', index: 'SMSG_CC', label: '<spring:message code="xx.copier" />', sortable: false, width: 100},
        {name: 'SMSG_DESC', index: 'SMSG_DESC', label: '<spring:message code="xx.describe" />', sortable: false, width: 150},
    ];
    ...
    $(function () {
        ...
        initTable(ctx+"/msgTask/queryMailData",colModel,tableCallBack,config);
    });
