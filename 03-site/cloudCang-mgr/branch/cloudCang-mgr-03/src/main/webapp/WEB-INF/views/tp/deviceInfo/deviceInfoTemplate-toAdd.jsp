...
<div class="ibox-content">
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form" action="${ctx}/deviceInfoTemplate/add" method="post" id="myForm">
                <div class="layui-form-item">
                    <div class="layui-col-md6">
                        <label class="layui-form-label"><spring:message code="tpinfotoadd.template.name" /></label>
                        <div class="layui-input-inline">
                            <input type="text" name="sname" id="sname" datatype="*" nullmsg='<spring:message code="tpinfotoadd.please.enter.a.template.name" />'
                                   value="" class="layui-input" placeholder='<spring:message code="tpinfotoadd.required" />...'/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="sreaderSerialNumber" id="sreaderSerialNumber" value=""
                                   class="layui-input"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                ...
                <%--<option value=""><spring:message code="tpinfotoadd.please.choose" /></option>--%>
                ...
                <%--</div>--%>
                <%--<div class="layui-col-md6">--%>
                <%--<label class="layui-form-label"><spring:message code="tpinfotoadd.put.it.into.the.city" /></label>--%>
                <%--<div class="layui-input-inline">--%>
                ...
                <div class="layui-form-item">
                    <%--<div class="layui-col-md6">--%>
                    <%--<label class="layui-form-label"><spring:message code="tpinfotoadd.delivery.to.districts.and.counties" /></label>--%>
                    <%--<div class="layui-input-inline">--%>
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="icontainerType" id="icontainerType" entire="true"
                                         value="" list='{10:springMessageCode=tpinfotoadd.single.door,20:springMessageCode=tpinfotoadd.double.door}'/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="dic" groupNo="SP000175" entire="true"
                                         ...
                                         value="" entireName='springMessageCode=tpinfotoadd.please.select.the.screen.display.type'
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="icompressorType" id="icompressorType" entire="true"
                                         value="" list='{10:springMessageCode=tpinfotoadd.refrigeration,20:springMessageCode=tpinfotoadd.heating,30:springMessageCode=tpinfotoadd.cooling.heat,40:springMessageCode=tpinfotoadd.no.compressor}' />
                        </div>
                    </div>
                    <div class="layui-col-md6">
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="idockingType" id="idockingType"
                                         entire="true" value="1" list="{10:independent research and development,20:third party}"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                        <label class="layui-form-label">whether to open the door to shop in real time</label>
                        <div class="layui-input-inline">
                            <cang:select type="list" name="iisOpeningInventory" id="iisOpeningInventory"
                                         entire="true" value="" list='{0:springMessageCode=main.no,1:springMessageCode=main.yes}'/>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item" style="display:none;" name="iweightDiv" id="iweightDiv">
                    <div class="layui-col-md6">
                        <label class="layui-form-label"><spring:message code="tpinfotoadd.system.docking.type" /></label>
                        <div class="layui-input-inline">
                            <cang:select type="list" name="idockingType" id="idockingType"
                                         entire="true" value="1" list='{10:springMessageCode=tpinfotoadd.independent.research.and.development,20:springMessageCode=tpinfotoadd.third.party}'/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea id="sremark" name="sremark" class="layui-textarea layui-form-textarea80p"
                                  placeholder='<spring:message code="sh.remarks" />（<spring:message code="main.optional" />）'></textarea>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layedit', 'element'], function () {
        ...
        form.on('select(supportWeigh)', function (data) {
            if (1 == data.value) {
                $("#iweightDiv").css("display", "block");
            } else {
                $("#iweightDiv").css("display", "none");
                $("#iweightType").val("");
