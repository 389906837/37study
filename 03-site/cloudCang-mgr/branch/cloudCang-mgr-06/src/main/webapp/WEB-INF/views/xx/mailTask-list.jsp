                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline" style="width: 182px">
                                <input type="text" name="smsgRecipient" id="smsgRecipient" value=""
                                       placeholder="消息收件人..." class="layui-input">
                            </div>
                            <div class="layui-inline" style="width: 182px">
                            ...
                            <div class="layui-inline" style="width: 180px">
                                <input type="text" name="tbeginSendDatetimeStr" id="tbeginSendDatetimeStr"
                                       placeholder="发送时间" class="layui-input">
                            </div>
                                <div class="layui-inline" style="width: 182px">
...
<script type="text/javascript">
    ...
    var colModel = [{name: 'id', index: 'id', hidden: true},
        ...
        {name: 'SMSG_RECIPIENT', index: 'SMSG_RECIPIENT', label: "消息收件人", sortable: false, width: 150},
        {
            name: 'ISTATE',
            index: 'ISTATE',
            label: "消息状态",
            editable: true,
            formatter: "select",
            editoptions: {value: '1:待发送;2:正在发送;3:发送成功;4:发送失败;5:超额无效'},
            sortable: false,
            width: 90
        },
        {
        ...
        },
        {
            ...
            formatter: "select", editoptions: {value: '1:是;2:否'}, sortable: false, width: 90
        },
        {
        ...
        {name: 'SCONTENT', index: 'SCONTENT', label: "消息内容", sortable: false, width: 300},
        {name: 'SMSG_CC', index: 'SMSG_CC', label: "抄送人", sortable: false, width: 100},
        {name: 'SMSG_DESC', index: 'SMSG_DESC', label: "描述", sortable: false, width: 150},
    ];
    // 表格回调
