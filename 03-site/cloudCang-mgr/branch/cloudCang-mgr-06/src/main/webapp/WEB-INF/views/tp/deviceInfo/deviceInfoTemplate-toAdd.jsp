            ...
            <form class="layui-form" action="${ctx}/deviceInfoTemplate/add" method="post" id="myForm">
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="idockingType" id="idockingType"
                                         entire="true" value="1" list="{10:自主研发,20:第三方}"/>
                        </div>
                    </div>
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="iisOpeningInventory" id="iisOpeningInventory"
                                         entire="true" value="" list="{0:否,1:是}"/>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <cang:select type="list" name="iisBindTrash" id="iisBindTrash" entire="true" value=""
                                         list="{0:否,1:是}"/>
                        </div>
                    </div>
                </div>
