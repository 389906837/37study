                ...
                <form class="layui-form" action="${ctx}/msgTemplate/bat" method="post" id="myForm">
                    <div class="layui-form-item fixed-bottom">
                        <div class="layui-input-block">
                            ...
                            <button class="layui-btn" type="button" id="myFormSub">确认</button>
                        </div>
                    </div>
...
//                {name: 'sextInfo',index: 'sextInfo',label : "供应商扩展信息",sortable : false,width:100},
//                {name: 'sdesc',index: 'sdesc',label : "供应商描述",sortable : false,width:100},
            ],
