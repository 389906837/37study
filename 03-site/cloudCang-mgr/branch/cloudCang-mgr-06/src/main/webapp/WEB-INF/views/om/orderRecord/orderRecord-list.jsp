                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <cang:select type="list" id="ichargebackWay" name="ichargebackWay" value=""
                                             list="{10:商户代扣,20:主动支付,30:单次代扣,40:微信支付分代扣}" entire="true"
                                             entireName="请选择扣款方式"/>
                            </div>
                            <div class="layui-input-inline">
    ...
    $(function () {
        ...
        $("#gridTable").jqGrid({
            ...
            colModel: [{name: 'id', index: 'id', hidden: true},
                ...
                {
                    name: 'iactualRefundPont',
                    index: 'IACTUAL_REFUND_PONT',
                    label: "退回积分",
                    width: 100/*,
                    formatter: function (cellValue) {
                        return cellValue;
                ...
                {
                    name: 'fpointDiscountAmount',
                    index: 'FPOINT_DISCOUNT_AMOUNT',
                    label: "积分抵扣金额（元）",
                    width: 140,
                    formatter: function (cellValue) {
                        return cellValue;
                ...
                </c:if>
                {
                    ...
                    editoptions: {value: '10:商户代扣;20:主动支付;30:单次代扣;40:微信支付分代扣'}
                },
                {
                    name: 'ipayType', index: 'IPAY_TYPE', label: "支付类型", width: 100, formatter: "select",
                    editoptions: {value: '10:账户余额;20:银行卡;30:微信支付;40:支付宝;50:银联支付;60:现金支付;70:第三方支付;80:其他;90:积分抵扣'}
                },
            ...
            subGridRowExpanded: function (subgrid_id, row_id) {
                ...
                $("#" + subgrid_table_id).jqGrid({
                    ...
                    colModel: [
                        ...
                        {name: 'frefundAmount', index: 'FREFUND_AMOUNT', label: "退款金额（元）", width: 100},
                        {name: 'frefundPoint', index: 'FREFUND_POINT', label: "退回积分", width: 100}
