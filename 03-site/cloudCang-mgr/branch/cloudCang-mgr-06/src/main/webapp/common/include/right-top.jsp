        ...
        <div class="notice">
            ...
            <c:if test="${fn:length(announcementList) > 0}">
                <div class="notice-left overflow" >
                    <span style="float: left;" ><i class="icon noticeicon"></i><span>最新通知：</span></span>
                    <%--<div id="scrollDiv">
                        <ul>
            ...
            <div class="notice-right">
                ...
                <em onclick="window.location.href='${ctx}/mgr/logout'"><i class="icon"></i>退出</em>
            </div>
        </div>
    ...
    <div class="J_menuTabs">
        <div class="index-btnmid">
            <ul class="page-tabs-content">
                <li class="J_menuTab"><a href="javascript:;" class="active" data-id="${ctx}/mgr/index">首页</a></li>
            </ul>
        </div>
    </div>
