...
public class LabelInfoController extends GenericController {
    ...
    ResponseVo<List<LabelInfo>> getParentLabel(String pid) {
        ...
        return new ResponseVo<>(false, 111, "查询父标签集合出错");
    }
    ...
    public ResponseVo<LabelInfo> labelAdd(LabelInfo labelInfo) {
        ...
        try {
            ...
            //操作日志
            String logText = MessageFormat.format("新增商品标签，名称{0}", labelInfo.getSname());
        ...
        return new ResponseVo<>(false, 111, "添加商品标签信息出错");
    }
    ...
    ResponseVo<String> labelDelete(String[] checkboxId) {
        ...
        try {
            if (ArrayUtils.isNotEmpty(checkboxId)) {
                ...
                //操作日志
                String logText = MessageFormat.format("删除商品标签信息", "");
        ...
        return ErrorCodeEnum.ERROR_COMMON_SYSTEM.getResponseVo("系统异常删除商品标签失败！");
    }
        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != labelInfo) {
                    ...
                    String logText4 = MessageFormat.format("商品标签编辑按钮信息，标签名称{0}", labelInfo.getSname());
    ...
    ResponseVo<LabelInfo> labeltoEdit(LabelInfo labelInfo) {
        ...
        if (StringUtils.isNotBlank(sid)) {
            try {
                ...
                //操作日志
                String logText1 = MessageFormat.format("修改商品标签信息，标签名称{0}", labelInfo.getSname());
        ...
        return ErrorCodeEnum.ERROR_COMMON_PARAM.getResponseVo("编辑商品标签信息出错！");
    }
        ...
        try {
            if (StringUtils.isNotBlank(sid)) {
                ...
                if (null != labelInfo) {
                    ...
                    String logText4 = MessageFormat.format("查看商品标签信息，标签名称{0}", labelInfo.getSname());
                    LogUtil.addOPLog(LogUtil.AC_VIEW, logText4, null);
