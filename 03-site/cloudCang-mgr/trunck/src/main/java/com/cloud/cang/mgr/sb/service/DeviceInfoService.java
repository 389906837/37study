...
public interface DeviceInfoService extends GenericService<DeviceInfo, String> {
     ...
     * @throws Exception
     */
    ResponseVo<String> saveNewsUpdate(DeviceSelectVo selectVo, HttpServletRequest request) throws ServiceException, Exception;
     ...
     * @return
     */
    List<DeviceInfo> selectAllDeviceBySmerchantId(String channelId, Map<String, Object> paramMap);

    /**
     * 重置二维码
     */
    void updateSqrUrl(DeviceInfo deviceInfo);
}