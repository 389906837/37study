        ...
        <div class="ibox-content m-t">
            <div class="layui-form-item">
                <div class="layui-col-md6">
                    <label class="layui-form-label">升级语音类型</label>
                    <div class="layui-input-inline">
                        <input type="radio" name="voiceType"  value="10"  checked title="开门语音"/>
                        <input type="radio" name="voiceType"  value="20"  title="购物语音"/>
                        <input type="radio" name="voiceType"  value="30"  title="关门语音"/>
                    </div>
                </div>
                <div class="layui-col-md6">
                    <button type="button" class="layui-btn" id="videoButton">选择上传音频文件</button>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-col-md6">
