...
<%--
                                <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="initCategory()" ><i class="layui-icon layui-icon-refresh"></i>初始化数据</button>
--%>
                                <button class="layui-btn layui-btn-sm layui-btn-primary" onclick="initCategory()" ><i class="layui-icon layui-icon-refresh"></i>初始化数据
                                </button>
                            </shiro:hasPermission>
                        </div>
                    </div>
