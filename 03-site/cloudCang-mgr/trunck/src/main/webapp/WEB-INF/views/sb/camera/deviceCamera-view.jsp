    ...
    <div class="layui-form-item wflayui-form-item">
        <table  cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td class="text-left" style="width:18%">称重编号：</td>
                <td class="text-right" style="width:32%">${cameraConfig.sweightCode}</td>
            </tr>
            <tr>
                <td class="text-left"  style="width:18%">从机地址：</td>
                <td class="text-right"  style="width:32%">${cameraConfig.slaveAddress}</td>
