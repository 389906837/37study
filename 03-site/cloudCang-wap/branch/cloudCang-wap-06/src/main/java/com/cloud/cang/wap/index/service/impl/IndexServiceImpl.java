...
import com.cloud.cang.weixin.util.StringUtils;
...
public class IndexServiceImpl extends GenericServiceImpl<Object, String> implements IndexService {
        ...
        if (types == 10) {
            ...
            if (isupportPayWay.intValue() == 10 || isupportPayWay.intValue() == 20) {
                ...
                if (deviceVo.getOpenSource().equals("wechat")) {//微信
                    ...
                    map.put("iwechatWithholdType", merchantConf.getIwechatWithholdType());/* 微信代扣方式 10:签约免密  20:微信支付分 */
    ...
    private String getwxPointConfig(String url, boolean debug) throws Exception {
        ...
        logger.info("微信支付分开启服务JS参数：{}", jsonStrPoint);
        return jsonStrPoint;
    }
}
