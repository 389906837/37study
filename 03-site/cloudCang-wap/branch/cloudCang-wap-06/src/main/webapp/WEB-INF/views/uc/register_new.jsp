...
<div class="reg_container">
    ...
    <div class="reg_main" style="margin-top: 45px;">
        <div class="reg_form">
            <div class="form_content">
                <span>手机号</span>
                <div class="form_input"><input type="number" id="mobileNumber" name="mobileNumber"
                                               placeholder="请输入您注册的手机号" maxlength="11"
                                               oninput="if(value.length>11)value=value.slice(0,11)"></div>
            </div>
...
<div class="popup_bg close">
    <div class="popup_contant md">
        ...
        <div class="iphonecode_input">
            <input type="number" id="yzm_1" name="yzm_1" onkeyup="changeVal(this);"
                   oninput="if(value.length>1)value=value.slice(0,1);" maxlength="1"/>
            <input type="number" id="yzm_2" name="yzm_2" onkeyup="changeVal(this);"
                   oninput="if(value.length>1)value=value.slice(0,1);" maxlength="1"/>
            <input type="number" id="yzm_3" name="yzm_3" onkeyup="changeVal(this);"
                   oninput="if(value.length>1)value=value.slice(0,1);" maxlength="1"/>
            <input type="number" id="yzm_4" name="yzm_4" onkeyup="changeVal(this);"
                   oninput="if(value.length>1)value=value.slice(0,1);" maxlength="1"/>
        </div>
