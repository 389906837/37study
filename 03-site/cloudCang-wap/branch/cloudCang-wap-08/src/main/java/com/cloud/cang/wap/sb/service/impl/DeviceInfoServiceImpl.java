...
public class DeviceInfoServiceImpl extends GenericServiceImpl<DeviceInfo, String> implements
     ...
     */
    @Override
    public List<DeviceVo> selectUseDevice(String queryCondition) {
        return deviceInfoDao.selectUseDevice(queryCondition);
    }
     ...
     */
    @Override
    public DeviceInfo selectByAiId(String aiId) {
        return deviceInfoDao.selectByAiId(aiId);
    }
}