                    ...
                    <c:forEach items="${commodities}" var="item" varStatus="L">
                        <c:if test="${item.forderCount>item.frefundCount and item.factualAmount > 0}">
                            <li class="refund_inforLi_flex" data="${item.id}">
                                ...
                                <div class="refund_img"><img src="${staticSource}/static/images/cartpic_2.png">
                                </div>
                                <div class="shop_info">
                ...
                <ul class="clearfix">
                    <c:forEach begin="1" end="${uploadNum}" var="item">
                        ...
                        <li onclick="selectPhoto(this);" data="${item}">
                            <img style="width:1.65rem;height:1.65rem;vertical-align:middle;" src="${staticSource}/static/images/refund-jiapic.png"/>
                        </li>
                    </c:forEach>
                </ul>
            </div>
