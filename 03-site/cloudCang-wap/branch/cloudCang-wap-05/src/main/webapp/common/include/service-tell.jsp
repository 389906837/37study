...
<div id="lxkf" class="popup_bg close">
    <div class="popup_contant md popup_pd">
        <h4 class="popup_lxkf_h4">Contact customer service immediately? </h4>
        <p style="font-size:1rem;" id="serviceTell">400-2828-3737</p>
        <p style="font-size:1rem;" id="serviceTime">Service time：9:00-17:00</p>
        <div class="popup_mt">
            <a class="btn btn_gray" href="javascript:void(0);" onclick="cancelBtn();" style="width: 40%">Cancel</a>
            <a class="btn btn_bluefill" id="serviceTellBtn" href="tel:400-828-3737" style="width: 40%">Ok</a>
        </div>
    </div>
</div>
            ...
            success:function (msg) {
                if (msg.success && !Util.isEmpty(msg.data)) {
                    if(!Util.isEmpty(msg.msg)) {
                        $("#serviceTime").html("Service time：" + msg.msg);
                    }
