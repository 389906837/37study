...
<div class="cart_container close" id="shoppingRealtime">
    ...
    <div class="cart_fixed close">
        <p>
            <span>Total number：<i id="totalNum">0</i></span>&nbsp;
            <span>Discount amount：￥<i id="discountedPrice">0.00</i></span>
        </p>
        <p class="cart_fixed_money"><em>Actual payment amount：￥</em><i id="actuallyPaid">0.00</i></p>
    </div>
</div>
