...
Util.EmptyData = function(text,inparams) {
    ...
    var html = '<div id="'+params.wid+'" class="md '+params.aclass+'"><img class="emptyData pic404" src="'+params.imageUrl+'"><p>'+text+'</p></div>';
    $("#"+params.wrapId).html(html);
    var allHg=$(window).height();
    $(".error-main").css("padding-top",allHg/4);
};
