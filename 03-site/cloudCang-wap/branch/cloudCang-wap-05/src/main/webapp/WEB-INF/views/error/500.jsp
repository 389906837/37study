...
<html>
<head>
    <title>The system crashed</title>
...
<div class="container error_main">
    <div class="md">
        ...
        <p>Oops, the server is wrong, try refreshing</p>
        <div style="margin: 0 1rem;">
            <a class="error_btn" href="javascript:void(0);" onclick="jumpIndexMain();">Back to home</a>
        </div>
    </div>
</div>
