...
<div class="refund_container">
    <form action="${ctx}/order/generateRefundOrder" method="post" id="myForm" onsubmit="return false;"
        ...
        <div class="refund_info m-b-07">
            <h4 class="refund_info_title">Apply for refund information</h4>
            <div class="refund_info_checkAll">
                <i id="commoditityMsg">Please select the item you want to apply for a refund</i>
                <span><img src="${staticSource}/static/images/check_icon.png"
                           msrc="${staticSource}/static/images/check_icon_hover.png" class="check_icon">Check all</span>

            </div>
        </div>

        <div class="refund_list m-b-07">
            <p class="refund_infor_num">Order number：${orderRecord.sorderCode}</p>
                        ...
                        <c:if test="${item.forderCount>item.frefundCount and item.factualAmount > 0}">
                            <li class="refund_inforLi_flex" data="${item.id}">
                                ...
                                <div class="shop_info">
                                    ...
                                    <p class="shop_pay_money">Actual payment amount：￥<span id="actualAmount_${item.id}"><f:formatNumber
                                            pattern="##0.00"
            ...
            <div class="shop_money_total">Real payment:<span>￥<i id="totalRefundAmount"><f:formatNumber pattern="##0.00"
                                                                                               value="${empty totalActualAmount ? 0 : totalActualAmount }"/></i></span>
            </div>
        </div>

        <div class="refund_money m-b-07">
            <h4>Refund Request：￥<i class="totalprice" id="applyRefundAmount">0.00</i></h4>
        </div>
        ...
        <div class="refund_reason m-b-07">
            <h4>Apply for reason</h4>
            <textarea placeholder="Please enter the reason for the refund" id="refundReason" onkeyup="checkLength(this);" name="refundReason"
        ...
        <div class="p_1">
            <a class="reg_btn" id="myFormSub" href="javascript:void(0);">Submit</a>
        </div>
    </form>
</div>
    ...
    $(function () {
        ...
        $("#myFormSub").click(function () {
            if (Util.isEmpty($("#commoditieIds").val())) {
                Util.Alert("Please select the refund item");
                return;
            }
