...
<head>
    ...
    <link rel="stylesheet" href="${staticSource}/static/css/index.css?1.3"/>
...
<%-- 补货员首页 --%>
<%@ include file="/common/include/replenishment.jsp" %>
<%--补货开门成功--%>
<%@ include file="/common/include/replenishmentOpenSuccess.jsp" %>
<%-- 实时订单 --%>
<%@ include file="/common/include/replenishmentRealtimeOrder.jsp" %>
...
<script type="text/javascript" src="${staticSource}/static/js/util.js?224"></script>
<script type="text/javascript" src="${staticSource}/static/js/socket.io.js"></script>
<script type="text/javascript" src="${staticSource}/static/js/soketUtilN.js?version=124"></script>
...
<script type="text/javascript">
    ...
    function closeTip() {
        ...
        openFlag = true;
        $(".opendoor").attr("onclick", "openDoor(1);");
        //$(".opendoor").html("<span>补</span><span>货</span><span>开</span><span>门</span>");
        if (isExit) {
            exitApp();
        }
    }
