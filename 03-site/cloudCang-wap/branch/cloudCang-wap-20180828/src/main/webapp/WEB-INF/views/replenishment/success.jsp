    ...
    <div class="container">
        <div class="container-c">
            ...
            <div class="kaimen-bg md" style="padding-bottom:10.5rem;">
                ...
                <p class="opensuccess">补货员姓名：${srealName} <a href="javascript:void(0);" onclick="myReplenishmentOrder();">我的历史补货单</a></p>
                <p class="opensuccess">本次实际上架数量：${empty addSize ? 0 : addSize } <c:if test="${(empty addSize ? 0 : addSize)>0 }"><a id="add-shelf-details" href="javascript:void(0);">详细信息</a></c:if></p>
                <p class="opensuccess">本次实际下架数量：${empty subSize ? 0 : subSize } <c:if test="${(empty subSize ? 0 : subSize)>0 }"><a id="sub-shelf-details" href="javascript:void(0);">详细信息</a></c:if></p>
                <p class="opensuccess markingDone">是否完成计划补货单 <a class="btn" href="javascript:void(0);" onclick="markingDone('${deviceCode}');">标记完成</a></p>
