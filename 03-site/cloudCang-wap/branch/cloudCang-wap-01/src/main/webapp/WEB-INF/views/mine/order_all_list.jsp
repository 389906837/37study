...
<head>
    ...
    <link rel="stylesheet" href="${staticSource}/static/css/style.css?2.100" />
</head>
<body>
                        ...
                        if("" != data) {
                            ...
                            if (data.length ==0) {
                                if(parseInt(page_index) == 1) {
                                  ...
                                  /*  $("#dataList"+itype).html("");
                                    Util.Loadfailure("暂无订单记录!",{subheight:90,imageUrl : staticPathRoot+'/static/images/norecords.png',wrapId:"dataList"+itype,wid:"loading_failure"+itype});*/
                                    //page_index = parseInt(page_index)-1;
