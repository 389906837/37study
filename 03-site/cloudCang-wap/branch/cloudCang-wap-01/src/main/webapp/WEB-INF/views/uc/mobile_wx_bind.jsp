...
<body>
<%--<form action="${ctx}/uc/register" method="post" id="myForm">--%>
    <div class="container">
        ...
        <div class="iphone-wrap">
            <div class="iphone-list">
                ...
                <input type="number" name="mobileNumber" id="mobileNumber" placeholder="请输入注册手机号" />
            </div>
    ...
    <div class="popup-bg" >
        <div class="popup-contant md">
            ...
            <div class="iphonecode-input">
                <input type="number" name="yzm_1" unselectable="on" id="yzm_1" onkeyup="changeVal(this);" maxlength="1" />
                <input type="number" name="yzm_2" unselectable="on" id="yzm_2" onkeyup="changeVal(this);" maxlength="1" />
                <input type="number" name="yzm_3" unselectable="on" id="yzm_3" onkeyup="changeVal(this);" maxlength="1" />
                <input type="number" name="yzm_4" unselectable="on" id="yzm_4" onkeyup="changeVal(this);" maxlength="1" />
            </div>
        </div>
    </div>
<%--</form>--%>
