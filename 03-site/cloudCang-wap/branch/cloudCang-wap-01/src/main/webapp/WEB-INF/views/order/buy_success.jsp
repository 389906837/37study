...
<head>
    ...
    <link rel="stylesheet" href="${staticSource}/static/css/style.css?21.1">
</head>
<body>
    ...
    <div class="container bg-c-f">
        <div class="container-c">
            <div class="buy-success md">
                ...
                <h4>购买成功!</h4>
                <p><c:if test="${ichargebackWay eq 10}">您的订单会自动扣款,</c:if><c:if test="${ichargebackWay ne 10}">您的订单需手动付款,</c:if><a href="javascript:void(0);" onclick="myOrder()" class="a-code">点击订单查看详情</a></p>
                <p>如有任何问题请联系客服</p>
            </div>
            <c:if test="${fn:length(coupons) > 0 or integral>0}">
                <div class="buy-quan" style="margin-bottom: 10.5rem;">
