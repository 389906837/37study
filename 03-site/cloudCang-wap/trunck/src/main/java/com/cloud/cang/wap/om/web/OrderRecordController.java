...
public class OrderRecordController {
     ...
     * @throws Exception
     */
    @RequestMapping("/shoppingCloudRealTimeOrderEmpty")
    public String shoppingCloudRealTimeOrderEmpty() {
        logger.debug("云端识别购物实时订单开始");
        return "order/empty_shoppingCart";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/replenishmentCloudRealTimeOrderEmpty")
    public String replenishmentCloudRealTimeOrderEmpty() {
        logger.debug("云端识别购物实时订单开始");
        return "replenishment/shelfGoods";
    }
