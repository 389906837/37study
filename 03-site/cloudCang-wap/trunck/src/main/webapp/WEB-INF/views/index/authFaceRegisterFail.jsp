...
<div class="container">
    ...
    <div class="page__bd_spacing">
        <%--<a href="${ctx}/index/main" class="cell-btn cell-btn_primary">确定</a>--%>
        <%--<a class="fanhui-btn" href="javascript:void(0);" onclick="alipayExitApp();">确定</a>--%>
        <a class="cell-btn cell-btn_primary" href="javascript:void(0);" onclick="alipayExitApp();">确定</a>
    </div>
