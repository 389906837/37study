    ...
    <div class="container">
        <div class="container-c">
            <div class="md logo-pack">
                <div class="logo">
                    <img src="<c:if test="${empty slogo}">${staticSource}/static/images/logo.png</c:if><c:if test="${!empty slogo}">${dynamicSource}${slogo}</c:if>" class="logo-pic" />
                    <span>|</span>
                    <div class="replenishment shoping-cart" onclick="jumpIndex();"><img src="${staticSource}/static/images/shopping-cart.png"/>我要购物</div>
                </div>
