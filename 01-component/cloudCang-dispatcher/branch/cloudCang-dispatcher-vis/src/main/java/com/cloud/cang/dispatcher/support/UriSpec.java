...
public class UriSpec implements Iterable<UriSpec.Part>
{
    ...
    public static final String      FIELD_SERVICE_PATH = "service-path";
    
    /**
     * 上下文
     */
    public static final String      FIELD_APP_CONTEXT = "app-context";
    ...
    public String   build(ServiceInstance serviceInstance, Map<String, Object> variables)
    {
        ...
        if ( serviceInstance != null )
        {
            ...
            localVariables.put(FIELD_ADDRESS, nullCheck(serviceInstance.getIpAddress()));
            ...
            localVariables.put(FIELD_SERVICE_PATH, nullCheck(serviceInstance.getServicePath()));
            localVariables.put(FIELD_APP_CONTEXT, nullCheck(serviceInstance.getAppContext()));
            
            if ( serviceInstance.getSslPort() != null && serviceInstance.getSslPort() > 0)
            {
