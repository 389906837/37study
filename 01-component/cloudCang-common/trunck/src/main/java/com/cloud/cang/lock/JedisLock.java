...
public class JedisLock {
     ...
     */
    public JedisLock(JedisCluster jedis, String lockKey, int acquireTimeoutMillis) {
     ...
     */
    public JedisLock(JedisCluster jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis) {
     ...
     */
    public JedisLock(JedisCluster jedis, String lockKey, int acquireTimeoutMillis, int expiryTimeMillis, UUID uuid) {
        this.jedis = jedis;
     ...
     *             in case of thread interruption
     */
    protected synchronized boolean acquire(JedisCluster jedis) throws InterruptedException {
     ...
     * @param jedis
     */
    protected synchronized void release(JedisCluster jedis) {
        if (isLocked()) {
