 ...
 * @Description: 柜子层数重力值
 * @Author: zengzexiong
 * @Date: 2018年10月31日15:16:34
 */
public class LayerGravityModel extends SuperDto {
    ...
    private List<CargoRoadGravityModel> cargoRoadGravityModelList; // 重力值（保留暂时不用）
    ...
    public List<CargoRoadGravityModel> getCargoRoadGravityModelList() {
        return cargoRoadGravityModelList;
    }

    public void setCargoRoadGravityModelList(List<CargoRoadGravityModel> cargoRoadGravityModelList) {
        this.cargoRoadGravityModelList = cargoRoadGravityModelList;
    }

    @Override
    public String toString() {
        return "LayerGravityModel{" +
                "layerNo='" + layerNo + '\'' +
