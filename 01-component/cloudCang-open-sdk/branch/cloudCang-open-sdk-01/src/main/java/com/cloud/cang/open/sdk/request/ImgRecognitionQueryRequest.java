...
/**
 * @version 1.0
 * @Description: 图片视觉识别订单查询接口请求参数类
 * @Author: zhouhong
 * @Date: 2018/9/4 15:09
 */
public class ImgRecognitionQueryRequest implements BaseRequest<ImgRecognitionQueryResponse> {
    ...
    public String getApiMethodName() {
        return "cloud.api.recognition.query";
    }
    ...
    @Override
    public Class<ImgRecognitionQueryResponse> getResponseClass() {
        return ImgRecognitionQueryResponse.class;
    }
}
