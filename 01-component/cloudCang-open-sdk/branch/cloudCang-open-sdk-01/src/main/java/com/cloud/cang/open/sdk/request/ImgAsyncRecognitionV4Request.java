...
import com.cloud.cang.open.sdk.response.RecognitionResponse;
...
/**
 * @version 1.0
 * @Description: 图片异步视觉识别YOLOV4请求参数类
 * @Author: yanlingfeng
 * @Date: 2020/1/13 09:21
 */
public class ImgAsyncRecognitionV4Request  implements BaseRequest<RecognitionResponse> {
    ...
    public String getApiMethodName() {
        return "cloud.api.recognition.yolov4.async";
    }
    ...
    @Override
    public Class<RecognitionResponse> getResponseClass() {
        return RecognitionResponse.class;
    }
}
