 ...
 **/
public class ServerList extends GenericEntity {
    ...
    /* 初始化状态
            ...
            20=在线
            30=在线并且模型已初始化 */
    private Integer irunStatus;

    public Integer getIrunStatus() {
        return irunStatus;
    }

    public void setIrunStatus(Integer irunStatus) {
    ...
    /* 识别显卡分配参数
            json 参数 */
    private String scpuConfig;

    public String getScpuConfig() {
        return scpuConfig;
    }

    public void setScpuConfig(String scpuConfig) {
        this.scpuConfig = scpuConfig;
    }
