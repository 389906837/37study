...
public class Utils {
	...
	public static File createFile(String packagee, String fileName,
								  String postFix) throws UnsupportedEncodingException {
		Properties properties =  Generator.properties;
		String currrntPath = new File("").getAbsolutePath();
		if (null != properties){
			String path = properties.getProperty("genFilePath");
			if (StringUtils.isNotBlank(path)){
				currrntPath = path;
			}
		}

		//idea 路径问题，这里取class路径
		...
		System.out.println("生成代码路径:"+currrntPath);
