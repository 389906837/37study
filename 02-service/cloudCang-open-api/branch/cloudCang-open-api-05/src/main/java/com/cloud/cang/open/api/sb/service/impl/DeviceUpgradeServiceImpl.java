...
import com.cloud.cang.open.api.sb.dao.DeviceUpgradeDao;
...
public class DeviceUpgradeServiceImpl extends GenericServiceImpl<DeviceUpgrade, String> implements
	...
	@Override
	public DeviceUpgrade selectSyncByPrimaryKey(String updateRecodeCode) {
		return deviceUpgradeDao.selectSyncByPrimaryKey(updateRecodeCode);
	}
}