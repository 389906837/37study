...
public enum SubCodeEnum {
    ...
    IMAGE_WIDTH_ERROR("INVALID-IMAGE-WIDTH", "图片尺寸异常!"),
    UPLOAD_IMAGE_EMPTY("UPLOAD-IMAGE-EMPTY", "第三方调用识别, 图片地址为空"),
    MODEL_NOT_EXIST("MODEL-NOT-EXIST", "第三方调用识别, 模型不存在"),
    UPLOAD_IMG_NOT_EXIST("UPLOAD-IMG-NOT-EXIST", "第三方调用识别, 图片不存在");
