...
public interface InterfaceAcceptService extends GenericService<InterfaceAccept, String> {
     ...
     * 新增业务受理记录
     *
     * @param recongitionVo 接口信息
     */
    void addInterfaceAcceptRecord(RecongitionVo recongitionVo);
     ...
     * @param params        请求参数
     */
    void updateInterfaceAcceptByFailed(String batchNo, AppManage app, InterfaceInfo interfaceInfo,
                                       SubCodeEnum subCodeEnum, CommonParam params);
     ...
     * @param params              请求参数
     */
    void updateInterfaceAcceptBySuccess(String outBatchNo, String requestData, Integer imgSize,
                                        Integer successNum, String batchNo, String backBody, String encryptBackBody,
                                        String callbackBody, String encryptCallbackBody, AppManage app, CommonParam params);
    ...
    InterfaceAccept getInterfaceAccept(String batchNo, String sappId) throws Exception;
}