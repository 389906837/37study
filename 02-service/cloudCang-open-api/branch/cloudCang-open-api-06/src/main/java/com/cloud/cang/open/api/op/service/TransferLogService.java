...
public interface TransferLogService extends GenericService<TransferLog, String> {
     ...
     * @param content 操作内容
     */
    void addTransferLog(String clientIp, String batchNo, AppManage app, InterfaceInfo interfaceInfo,
                        int itype, String operType, String content);


    void addTransferLog(RecongitionVo recongitionVo, String operType, String content);
