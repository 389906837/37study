...
public class RequestUtil {
    ...
    public static CommonParam parseCommonParam(HttpServletRequest request){
        CommonParam commonParam = BeanUtil.mapToBean(getRequestParams(request),
                CommonParam.class,true);
        return commonParam;
    }
}
