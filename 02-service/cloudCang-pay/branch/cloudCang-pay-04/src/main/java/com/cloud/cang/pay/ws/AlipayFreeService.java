...
public class AlipayFreeService {
	...
	public ResponseVo<FreePaymentResult> payment(@RequestBody FreePaymentDto freePaymentDto, HttpServletRequest request) {
		...
		try {
			...
			freePaymentDto.setSip(RequestUtils.getIpAddr(request));
