...
public interface OrderRecordService extends GenericService<OrderRecord, String> {
     ...
     * @return
     */
    ResponseVo<CreatSmartretailOrderResult> creatSmartretailOrder(CreatSmartretailOrderDto creatSmartretailOrderDto) throws Exception;
    /**
     * 微信支付分创建订单
     *
     * @param creatSmartretailOrderDto
     * @return
     */
    ResponseVo<CreatSmartretailOrderResult> creatSmartretailOrderN(CreatSmartretailOrderDto creatSmartretailOrderDto) throws Exception;
     ...
     * @return
     */
    ResponseVo<EndSmartretailOrderResult> endSmartretailOrder(EndSmartretailOrderDto endSmartretailOrderDto) throws Exception;
    /**
     * 微信支付分完结订单
     *
     * @param endSmartretailOrderDto
     * @return
     */
    ResponseVo<EndSmartretailOrderResult> endSmartretailOrderN(EndSmartretailOrderDto endSmartretailOrderDto ) throws Exception;
     ...
     * @return
     */
    ResponseVo<EndSmartretailOrderResult> deneratingOrders(CreatSmartretailOrderDto creatSmartretailOrderDto) throws Exception;
     ...
     * @return
     */
    ResponseVo<CancelSmartretailOrderResult> cancelOrders(CancelSmartretailOrdersDto cancelSmartretailOrdersDto) throws Exception;
     ...
     * @return
     */
    ResponseVo<SyncOrderResult> syncOrders(SyncOrdersDto syncOrdersDto) throws Exception;
     ...
     * @return
     */
    ResponseVo<QuerySmartretailOrderResult> querySmartretailOrder(QuerySmartretailOrderDto querySmartretailOrderDto) throws Exception;
    /**
     * 微信支付查询并且完结订单
     *
     ...
     * @return
     */
    ResponseVo<EndSmartretailOrderResult> createAndEndSmartretailOrder(QueryAndEndSmartretailOrderDto queryAndEndSmartretailOrderDto)throws Exception;
     ...
     */
/*
    boolean dealwithWechatConfirmOrder(String sip, WechatPointsNotifyData wechatPointsNotifyData, MerchantConf conf) throws Exception;
*/
     ...
     * @throws Exception
     */
    boolean dealwithWechatReceivables(String sip, WechatPointsNotifyData receivablesNotifyData, MerchantConf conf) throws Exception;


    void closeOrder(String outout_order_no,String merchantCode) throws Exception;

    void queryCert() throws Exception;

    /**
     * Vendstop支付
     * @param freePaymentDto 支付参数
     */
    ResponseVo<OrderRecord> createVendstopPay(FreePaymentDto freePaymentDto);
}