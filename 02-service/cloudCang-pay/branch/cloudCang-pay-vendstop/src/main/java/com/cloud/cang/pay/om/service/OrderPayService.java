...
public interface OrderPayService extends GenericService<OrderPay, String> {
     ...
     * @return
     */
    OrderPay insertOrderPay(OrderRecord orderRecord, Integer payType,Integer iisWechatPayPointOrder) throws Exception;
    /**
     * 新增订单支付信息数据
     *
     * @param orderRecord 订单数据
     ...
     * @return
     */
    OrderPay insertOrderPayN(OrderRecord orderRecord, Integer payType,Integer iisWechatPayPointOrder,String code) throws Exception;
     ...
     * @return
     */
    String selectOutTradeNoByOrderCodeAsc(String outTradeNo);
}