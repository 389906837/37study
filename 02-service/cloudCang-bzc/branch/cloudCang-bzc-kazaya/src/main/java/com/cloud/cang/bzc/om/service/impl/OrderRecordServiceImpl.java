...
public class OrderRecordServiceImpl extends GenericServiceImpl<OrderRecord, String> implements
    ...
    public /*ResponseVo<List<CreatOrderResult>>*/  Map generateOrder(OrderCommDto orderCommDto) throws Exception {
        ...
        }else if(BizTypeDefinitionEnum.ClientType.KAZAYA.getCode() == isourceClientType){
            responseVo = insertOrder(orderDto, commodityDiscountDtoList, BizTypeDefinitionEnum.ClientType.KAZAYA.getCode());
        }
        Map map = new HashMap();
     ...
     * @param merchantConfType         商户客户端类型 10:微信  20:支付宝  80:KAZAYA
     * @return ResponseVo<List<OrderRecord>>
     */
