...
public interface DeviceStockService extends GenericService<DeviceStock, String> {
     ...
     * @return
     */
    ResponseVo<InventoryResult> closeGravityCommodityDeal(InventoryDto inventoryDto);
    /**
     * 分层重力柜关门
     *
     ...
     * @return
     */
    ResponseVo<InventoryResult> closeGravityLayeredCommodityDeal(LayeredInventoryDto layeredInventoryDto);
     ...
     * @param memberInfo   会员数据
     */
    Map<String, Object> calcRFIDCommodityDiffByType(InventoryDto inventoryDto, DeviceInfo deviceInfo, MemberInfo memberInfo);
}