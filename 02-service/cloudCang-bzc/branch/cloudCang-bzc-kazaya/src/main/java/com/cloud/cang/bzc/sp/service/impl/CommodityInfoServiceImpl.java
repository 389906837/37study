...
import com.cloud.cang.bzc.sp.dao.CommodityInfoDao;
...
public class CommodityInfoServiceImpl extends GenericServiceImpl<CommodityInfo, String> implements
	 ...
	 */
	@Override
	public CommodityInfo selectByScode(String scode, String smerchantId) {
		return commodityInfoDao.selectByScode(scode, smerchantId);
	}
}