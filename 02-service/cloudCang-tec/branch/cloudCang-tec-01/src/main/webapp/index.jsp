...
<html>
    <head>
        ...
        <style type="text/css">@import url('<c:url value="/static/components/calendar/skins/aqua/theme.css"/>');</style>
        <script type="text/javascript" src='<c:url value="/static/components/calendar/calendar.js"/>'></script>
        <script type="text/javascript" src='<c:url value="/static/components/calendar/calendar-setup.js"/>'> </script>
        <script type="text/javascript" src='<c:url value="/static/components/calendar/lang/calendar-zh_CN.js"/>'></script>
        <script type="text/javascript" src='<c:url value="/static/components/jquery/jquery-1.3.2.min.js"/>'></script>
        <script type="text/javascript" src='<c:url value="/static/components/jquery/jquery.form.js"/>'></script>
        <script type="text/javascript" src='<c:url value="/static/job.js"/>'></script>
    </head>
    <body>
        ...
        <form id="myForm1" action="${pageContext.request.contextPath}/JobProcessServlet?jobtype=0&action=add" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td ><input type="text" name ="p_triggerName" size="20"></td>
                    <td>（必填）</td>
                </tr>
                <tr>
