...
public class TecConstants {
     ...
     * 微信支付分付款处理中订单修改状态
     */
    public static final String UP_WECHAT_POINT_IN_PAYMENT_ORDER_TASK = "up_wechat_point_in_payment_order_task";
    /**
     * 完结创建微信支付分订单请求
     */
    public static final String END_WECHAT_POINT_CREATE_APPLY_TASK = "end_wechat_point_create_apply_task";
