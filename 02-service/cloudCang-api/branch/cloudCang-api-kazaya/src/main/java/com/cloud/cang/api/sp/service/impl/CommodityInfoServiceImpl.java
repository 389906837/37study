...
public class CommodityInfoServiceImpl extends GenericServiceImpl<CommodityInfo, String> implements
	...
	@Override
	public List<CommodityInfo> selectCommodityList(String smerchantId, String scode, String sname) {
		return commodityInfoDao.selectCommodityList(smerchantId,scode,sname);
	}
