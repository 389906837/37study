...
public class DeviceModelServiceImpl extends GenericServiceImpl<DeviceModel, String> implements
    ...
    public ResponseVo<DeviceModelConfigInfo> getDeviceModelConfigInfo(String deviceId) {
        ...
        if (null != deviceModel) {
            ...
            deviceModelConfigInfo.setScontrastMode(deviceModel.getScontrastMode());
            deviceModelConfigInfo.setIsupportSingleLayer(deviceModel.getIsupportSingleLayer());
            // 设备网络摄像头
            String sdeviceId = deviceModel.getSdeviceId();
            CameraConfig cameraConfigVo = new CameraConfig();
            cameraConfigVo.setSdeviceId(sdeviceId);
            ...
            if (CollectionUtils.isNotEmpty(cameraConfigList)) {
                deviceModelConfigInfo.setCameraConfigList(cameraConfigList);
            }
