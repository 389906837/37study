...
public class SessionVo implements Serializable {
    ...
    private String app_userAuthToken;//调用vendStop,userAuthToken
    private String app_sessionId;//调用vendStop sessionID
    private String app_deviceId;////调用vendStop 手机设备ID
    ...
    public String toString() {
        return "SessionVo{" +
                ...
                ", app_userAuthToken='" + app_userAuthToken + '\'' +
                ", app_sessionId='" + app_sessionId + '\'' +
