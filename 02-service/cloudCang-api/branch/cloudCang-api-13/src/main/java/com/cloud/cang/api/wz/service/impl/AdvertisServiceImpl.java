...
//				String id = GrpParaUtil.getValue(); // 从数据字典获取配置的运营区域，然后获取区域ID
     ...
     * 查询设备广告信息
     *
     * @param iscreenDisplayType 屏幕显示类型
     * @param scode              设备编号
     * @param sregionCode        广告运营位
     * @return
     */
    @Override
    public List<AdvertisModel> selectByDeviceCodeAndRegionCode(Integer iscreenDisplayType, String scode, String sregionCode, String merchantCode) {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("scode", scode);
        paramMap.put("sregionCode", sregionCode);
        paramMap.put("merchantCode", merchantCode);
        paramMap.put("iscreenDisplayType", iscreenDisplayType);
