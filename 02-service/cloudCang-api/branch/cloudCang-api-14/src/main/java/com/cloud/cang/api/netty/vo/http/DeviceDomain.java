...
public class DeviceDomain {
    ...
    Integer iweightStockNum;          //重力稳定盘货次数
    Integer ilayerNum;                //设备层数

    BigDecimal ielectronicFloat;    //电子秤允许浮动值

    Integer isupportWeigh;//是否支持称重

    String sserviceHours;//客服电话服务时间

    Integer iweightType;//称重类型
    ...
    public String getSserviceHours() {
        return sserviceHours;
    }

    public void setSserviceHours(String sserviceHours) {
        this.sserviceHours = sserviceHours;
    }
    ...
    public String toString() {
        return "DeviceDomain{" +
                ...
                ", listcell=" + listcell +
                ", iweightStockNum=" + iweightStockNum +
                ", ilayerNum=" + ilayerNum +
                ", ielectronicFloat=" + ielectronicFloat +
                ", isupportWeigh=" + isupportWeigh +
                ", sserviceHours='" + sserviceHours + '\'' +
                ", iweightType=" + iweightType +
                ", s485Address='" + s485Address + '\'' +
                '}';
    }
}
