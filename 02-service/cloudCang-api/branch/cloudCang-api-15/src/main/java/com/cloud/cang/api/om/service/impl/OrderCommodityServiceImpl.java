...
import com.cloud.cang.api.om.dao.OrderCommodityDao;
...
public class OrderCommodityServiceImpl extends GenericServiceImpl<OrderCommodity, String> implements
     ...
     */
    @Override
    public List<OrderCommodity> selectByOrderId(String orderId) {
        return orderCommodityDao.selectByOrderId(orderId);
    }
