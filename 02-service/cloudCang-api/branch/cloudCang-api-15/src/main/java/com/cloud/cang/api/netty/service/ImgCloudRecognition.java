...
public class ImgCloudRecognition {
     ...
     * @param uniquelyIdentifies 关门唯一表示
     * @return
     */
    @RequestMapping("/cloudCloseDoor")
    @ResponseBody
    public ResponseVo<String> cloudCloseDoor(String deviceId, String key, String userId, Integer openDoorType, String imgResultDetail, String uniquelyIdentifies) {
        ...
        try {
            ...
            if (10 == openDoorType) {
                try {
                    iCached.put(uniquelyIdentifies + "_" + deviceId, userId);
                } catch (Exception e) {
