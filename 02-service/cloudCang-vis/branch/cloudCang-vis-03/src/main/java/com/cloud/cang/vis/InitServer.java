...
/**
 * @program: 37cang-云平台
 * @description: 初始化服务-加载模型(vis服务启动时加载)
 * @author: qzg
...
public class InitServer implements InitializingBean {
    ...
    // isReload = true: reloadRecogitionServer()
    // isReload = false: loadRecogitionServer
    public void loadVisMoel(boolean isReload){
        ...
        logger.info("完成-初始化模型, ip:{}, port:{}, 模型编号：{}",host,port,model.getScode());
    }
}
