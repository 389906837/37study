...
public class TestDetectService {
    ...
    public ResponseVo<String> init() {
        ...
        try {
            ...
            String metaPath = "/data/fileServer/model/37.data";
            ...
            cellBean.setImageUrl("/data/fileServer/data/2019-11-01_141730_461.jpg");
            imageCellBeans.add(cellBean);
            //String reuslt = instance.recogitionImage(JSONObject.toJSONString(imageCellBeans));
            List<Mq_ImgResult.ImgResultItem> result = instance.recogitionImage(JSONObject.toJSONString(imageCellBeans));
            logger.info("recogitionImageByFileName is result =====>>>>>>>{}", result.toString());

//            reuslt = instance.recogitionImagePos(JSONObject.toJSONString(imageCellBeans));
//            logger.info("recogitionImageByFileNamePos is result =====>>>>>>>{}", reuslt);


            responseVo.setData(result.toString());
