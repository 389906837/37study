...
import com.cloud.cang.act.ac.dao.DiscountDetailDao;
...
public class DiscountDetailServiceImpl extends GenericServiceImpl<DiscountDetail, String> implements
	...
	@Override
	public List<DiscountDetail> selectBySacCode(String sacCode) {
		return discountDetailDao.selectBySacCode(sacCode);
	}
