...
import com.cloud.cang.act.ac.dao.CouponRuleDao;
import com.cloud.cang.model.ac.CouponRule;
import com.cloud.cang.act.ac.service.CouponRuleService;
...
public class CouponRuleServiceImpl extends GenericServiceImpl<CouponRule, String> implements
	...
	@Override
	public CouponRule selectCouponRuleByActivityId(String activityId) {
		return couponRuleDao.selectCouponRuleByActivityId(activityId);
	}
